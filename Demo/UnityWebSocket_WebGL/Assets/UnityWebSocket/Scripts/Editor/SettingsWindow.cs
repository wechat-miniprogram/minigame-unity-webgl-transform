...
namespace UnityWebSocket.Editor
{
    internal class SettingsWindow : EditorWindow
    {
        ...
        private void DrawLogo()
        {
            if (logoTex == null)
            {
                ...
                for (int i = 0; i < 66; i++)
                for (int j = 0; j < 15; j++)
                    logoTex.SetPixel(i, j, Color.clear);
                logoTex.Apply();
            }
        ...
        )
        {
            ...
            style.normal.textColor =
                (EditorGUIUtility.isProSkin ? Color.white : Color.black) * alpha;
        ...
        {
            GUI.Label(
                new Rect(330, 200, 100, 18),
                "GitHub:",
                TextStyle(10, TextAnchor.MiddleRight)
            );
        ...
        private void DrawFooter()
        {
            EditorGUI.DropShadowLabel(
                new Rect(10, 230, 400, 20),
                "Developed by " + Settings.AUHTOR
            );
    ...
    internal static class LOGO_BASE64
    {
        internal const string VALUE =
            "iVBORw0KGgoAAAANSUhEUgAAAEIAAABCCAMAAADUivDaAAAAq1BMVEUAAABKmtcvjtYzl"
