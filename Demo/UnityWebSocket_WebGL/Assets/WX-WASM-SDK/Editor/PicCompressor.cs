...
namespace WeChatWASM
{
    ...
    dstPath + "\"";
        ...
        {
            return Path.Combine(Application.dataPath, "WX-WASM-SDK/Editor/crunch" + (Application.platform == RuntimePlatform.WindowsEditor ? ".exe" : ""));
        }
        ...
        {  // pc端的压缩纹理
            ...
            p.StartInfo.Arguments = "-file \"" +
                src
                + "\" -fileformat dds -dxt5 -out \"" +
                dstPath + "\" -mipmode none";
