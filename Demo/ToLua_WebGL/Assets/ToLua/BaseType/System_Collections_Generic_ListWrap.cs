...
public class System_Collections_Generic_ListWrap
{
        ...
        try
        {
            ...
            else
            {
                return LuaDLL.luaL_throw(
                    L,
                    string.Format(
                        "invalid arguments to method: List<{0}>.BinarySearch",
                        LuaMisc.GetTypeName(argType)
                    )
                );
            }
        }
        ...
        try
        {
            ...
            else
            {
                return LuaDLL.luaL_throw(
                    L,
                    string.Format(
                        "invalid arguments to method: List<{0}>.CopyTo",
                        LuaMisc.GetTypeName(argType)
                    )
                );
            }
    ...
    static int Exists(IntPtr L)
    {
        try
        {
            ...
            Type argType = null;
            object obj = ToLua.CheckGenericObject(L, 1, typeof(List<>), out argType);
            Delegate arg0 = ToLua.CheckDelegate(
                typeof(System.Predicate<>).MakeGenericType(argType),
                L,
                2
            );
    ...
    static int FindIndex(IntPtr L)
    {
        try
        {
            ...
            {
                int arg0 = (int)LuaDLL.luaL_checknumber(L, 2);
                Delegate arg1 = ToLua.CheckDelegate(
                    typeof(System.Predicate<>).MakeGenericType(argType),
                    L,
                    3
                );
            ...
            else if (count == 4)
            {
                int arg0 = (int)LuaDLL.luaL_checknumber(L, 2);
                int arg1 = (int)LuaDLL.luaL_checknumber(L, 3);
                Delegate arg2 = ToLua.CheckDelegate(
                    typeof(System.Predicate<>).MakeGenericType(argType),
                    L,
                    4
                );
            ...
            else
            {
                return LuaDLL.luaL_throw(
                    L,
                    string.Format(
                        "invalid arguments to method: List<{0}>.FindIndex",
                        LuaMisc.GetTypeName(argType)
                    )
                );
            }
    ...
    static int FindLastIndex(IntPtr L)
    {
        try
        {
            ...
            if (count == 2)
            {
                Delegate arg0 = (Delegate)
                    ToLua.CheckObject(L, 2, typeof(System.Predicate<>).MakeGenericType(argType));
            ...
            {
                int arg0 = (int)LuaDLL.luaL_checknumber(L, 2);
                Delegate arg1 = (Delegate)
                    ToLua.CheckObject(L, 3, typeof(System.Predicate<>).MakeGenericType(argType));
            ...
            else if (count == 4)
            {
                ...
                Delegate arg2 = (Delegate)
                    ToLua.CheckObject(L, 4, typeof(System.Predicate<>).MakeGenericType(argType));
            ...
            else
            {
                return LuaDLL.luaL_throw(
                    L,
                    string.Format(
                        "invalid arguments to method: List<{0}>.FindLastIndex",
                        LuaMisc.GetTypeName(argType)
                    )
                );
            }
    ...
    static int ForEach(IntPtr L)
    {
        try
        {
            ...
            object obj = ToLua.CheckGenericObject(L, 1, typeof(List<>), out argType);
            Delegate arg0 = ToLua.CheckDelegate(
                typeof(System.Action<>).MakeGenericType(argType),
                L,
                2
            );
        ...
        try
        {
            ...
            else
            {
                return LuaDLL.luaL_throw(
                    L,
                    string.Format(
                        "invalid arguments to method: List<{0}>.IndexOf",
                        LuaMisc.GetTypeName(argType)
                    )
                );
            }
    ...
    static int InsertRange(IntPtr L)
    {
        try
        {
            ...
            object obj = ToLua.CheckGenericObject(L, 1, typeof(List<>), out argType);
            int arg0 = (int)LuaDLL.luaL_checknumber(L, 2);
            IEnumerable arg1 = (IEnumerable)
                ToLua.CheckObject(L, 3, typeof(IEnumerable<>).MakeGenericType(argType));
        ...
        try
        {
            ...
            else
            {
                return LuaDLL.luaL_throw(
                    L,
                    string.Format(
                        "invalid arguments to method: List<{0}>.LastIndexOf",
                        LuaMisc.GetTypeName(argType)
                    )
                );
            }
        ...
        try
        {
            ...
            if (count == 1)
            {
                ...
                && TypeChecker.CheckTypes(
                    L,
                    2,
                    typeof(System.Comparison<>).MakeGenericType(argType)
                )
            )
            {
                ...
                count == 2
                && TypeChecker.CheckTypes(L, 2, typeof(IComparer<>).MakeGenericType(argType))
            )
            {
