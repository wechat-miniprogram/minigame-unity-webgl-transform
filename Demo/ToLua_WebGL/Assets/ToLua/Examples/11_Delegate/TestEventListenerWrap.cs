...
public class TestEventListenerWrap
{
    ...
    static int SetOnFinished(IntPtr L)
    {
        try
        {
            ...
            {
                TestEventListener obj = (TestEventListener)
                    ToLua.CheckObject(L, 1, typeof(TestEventListener));
                TestEventListener.VoidDelegate arg0 = (TestEventListener.VoidDelegate)
                    ToLua.ToObject(L, 2);
            ...
            else
            {
                return LuaDLL.luaL_throw(
                    L,
                    "invalid arguments to method: TestEventListener.SetOnFinished"
                );
            }
        }
        catch (Exception e)
    ...
    static int set_onClick(IntPtr L)
    {
        ...
        try
        {
            o = ToLua.ToObject(L, 1);
            TestEventListener obj = (TestEventListener)o;
            TestEventListener.OnClick arg0 = (TestEventListener.OnClick)
                ToLua.CheckDelegate<TestEventListener.OnClick>(L, 2);
            obj.onClick = arg0;
            return 0;
        }
        catch (Exception e)
    ...
    static int set_TestFunc(IntPtr L)
    {
        ...
        try
        {
            o = ToLua.ToObject(L, 1);
            TestEventListener obj = (TestEventListener)o;
            System.Func<bool> arg0 = (System.Func<bool>)
                ToLua.CheckDelegate<System.Func<bool>>(L, 2);
            obj.TestFunc = arg0;
            return 0;
        }
        catch (Exception e)
    ...
    static int set_onClickEvent(IntPtr L)
    {
        try
        {
            ...
            else
            {
                return LuaDLL.luaL_throw(
                    L,
                    "The event 'TestEventListener.onClickEvent' can only appear on the left hand side of += or -= when used outside of the type 'TestEventListener'"
                );
            }
