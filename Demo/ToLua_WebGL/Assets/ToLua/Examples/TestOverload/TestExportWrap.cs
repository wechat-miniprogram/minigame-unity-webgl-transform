...
public class TestExportWrap
{
        ...
        try
        {
            ...
            else
            {
                return LuaDLL.luaL_throw(
                    L,
                    "invalid arguments to operator method: TestExport.this"
                );
            }
        }
        catch (Exception e)
    ...
    static int TestByteBuffer(IntPtr L)
    {
        try
        {
            ...
            TestExport obj = (TestExport)ToLua.CheckObject(L, 1, typeof(TestExport));
            TestExport.TestBuffer arg0 = (TestExport.TestBuffer)
                ToLua.CheckDelegate<TestExport.TestBuffer>(L, 2);
    ...
    static int Test(IntPtr L)
    {
        try
        {
            ...
            if (count == 1 && TypeChecker.CheckTypes<TestExport>(L, 1))
            {
                ...
                count == 2
                && TypeChecker.CheckTypes<TestExport, LuaInterface.LuaOut<int>>(L, 1)
            )
            {
                TestExport obj = (TestExport)ToLua.ToObject(L, 1);
                int arg0;
            ...
            else if (count == 4 && TypeChecker.CheckTypes<TestExport, object, string, int>(L, 1))
            {
                ...
                TypeChecker.CheckTypes<TestExport>(L, 1)
            ...
            )
            {
                ...
                TypeChecker.CheckTypes<TestExport>(L, 1)
                && TypeChecker.CheckParamsType<string>(L, 2, count - 1)
            )
            {
                TestExport obj = (TestExport)ToLua.ToObject(L, 1);
                ...
                TypeChecker.CheckTypes<TestExport>(L, 1)
                && TypeChecker.CheckParamsType<object>(L, 2, count - 1)
            )
            {
                TestExport obj = (TestExport)ToLua.ToObject(L, 1);
    ...
    static int Test33(IntPtr L)
    {
        try
        {
            ToLua.CheckArgsCount(L, 2);
            TestExport obj = (TestExport)ToLua.CheckObject(L, 1, typeof(TestExport));
            System.Action<int> arg0 = (System.Action<int>)
                ToLua.CheckDelegate<System.Action<int>>(L, 2);
    ...
    static int TestGeneric(IntPtr L)
    {
        try
        {
            ToLua.CheckArgsCount(L, 2);
            TestExport obj = (TestExport)ToLua.CheckObject(L, 1, typeof(TestExport));
            UnityEngine.Component arg0 = (UnityEngine.Component)
                ToLua.CheckObject<UnityEngine.Component>(L, 2);
    ...
    static int TestEnum(IntPtr L)
    {
        try
        {
            ToLua.CheckArgsCount(L, 2);
            TestExport obj = (TestExport)ToLua.CheckObject(L, 1, typeof(TestExport));
            TestExport.Space arg0 = (TestExport.Space)
                ToLua.CheckObject(L, 2, typeof(TestExport.Space));
    ...
    static int TestRefGameObject(IntPtr L)
    {
        try
        {
            ...
            UnityEngine.GameObject arg0 = (UnityEngine.GameObject)
                ToLua.CheckObject(L, 1, typeof(UnityEngine.GameObject));
    ...
    static int TestNullable(IntPtr L)
    {
        try
        {
            ToLua.CheckArgsCount(L, 2);
            TestExport obj = (TestExport)ToLua.CheckObject(L, 1, typeof(TestExport));
            System.Nullable<UnityEngine.Vector3> arg0 = ToLua.CheckNullable<UnityEngine.Vector3>(
                L,
                2
            );
    ...
    static int set_OnRefEvent(IntPtr L)
    {
        ...
        try
        {
            o = ToLua.ToObject(L, 1);
            TestExport obj = (TestExport)o;
            TestExport.TestRefEvent arg0 = (TestExport.TestRefEvent)
                ToLua.CheckDelegate<TestExport.TestRefEvent>(L, 2);
            obj.OnRefEvent = arg0;
            return 0;
        }
        catch (Exception e)
