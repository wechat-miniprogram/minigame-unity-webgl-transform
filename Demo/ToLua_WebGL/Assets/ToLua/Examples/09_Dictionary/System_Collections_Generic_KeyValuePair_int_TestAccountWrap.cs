...
public class System_Collections_Generic_KeyValuePair_int_TestAccountWrap
{
    ...
    {
        L.BeginClass(
            typeof(System.Collections.Generic.KeyValuePair<int, TestAccount>),
            null,
            "KeyValuePair_int_TestAccount"
        );
    ...
    static int _CreateSystem_Collections_Generic_KeyValuePair_int_TestAccount(IntPtr L)
    {
        try
        {
            ...
            if (count == 2)
            {
                ...
                System.Collections.Generic.KeyValuePair<int, TestAccount> obj =
                    new System.Collections.Generic.KeyValuePair<int, TestAccount>(arg0, arg1);
            ...
            {
                System.Collections.Generic.KeyValuePair<int, TestAccount> obj =
                    new System.Collections.Generic.KeyValuePair<int, TestAccount>();
                ToLua.PushValue(L, obj);
                return 1;
            }
            else
            {
                return LuaDLL.luaL_throw(
                    L,
                    "invalid arguments to ctor method: System.Collections.Generic.KeyValuePair<int,TestAccount>.New"
                );
            }
        }
        catch (Exception e)
    ...
    static int ToString(IntPtr L)
    {
        try
        {
            ...
            System.Collections.Generic.KeyValuePair<int, TestAccount> obj =
                (System.Collections.Generic.KeyValuePair<int, TestAccount>)
                    ToLua.CheckObject(
                        L,
                        1,
                        typeof(System.Collections.Generic.KeyValuePair<int, TestAccount>)
    ...
    static int get_Key(IntPtr L)
    {
        ...
        try
        {
            ...
            System.Collections.Generic.KeyValuePair<int, TestAccount> obj =
                (System.Collections.Generic.KeyValuePair<int, TestAccount>)o;
            int ret = obj.Key;
