...
public class System_Collections_Generic_Dictionary_int_TestAccountWrap
{
    ...
    static int _CreateSystem_Collections_Generic_Dictionary_int_TestAccount(IntPtr L)
    {
        try
        {
            ...
            if (count == 0)
            {
                System.Collections.Generic.Dictionary<int, TestAccount> obj =
                    new System.Collections.Generic.Dictionary<int, TestAccount>();
            ...
            else if (count == 1 && TypeChecker.CheckTypes<int>(L, 1))
            {
                ...
                System.Collections.Generic.Dictionary<int, TestAccount> obj =
                    new System.Collections.Generic.Dictionary<int, TestAccount>(arg0);
                ToLua.PushSealed(L, obj);
                return 1;
            }
            else if (
                count == 1
                && TypeChecker.CheckTypes<System.Collections.Generic.IDictionary<int, TestAccount>>(
                    L,
                    1
                )
            )
            {
                System.Collections.Generic.IDictionary<int, TestAccount> arg0 =
                    (System.Collections.Generic.IDictionary<int, TestAccount>)ToLua.ToObject(L, 1);
                System.Collections.Generic.Dictionary<int, TestAccount> obj =
                    new System.Collections.Generic.Dictionary<int, TestAccount>(arg0);
                ToLua.PushSealed(L, obj);
                return 1;
                ...
                count == 1
                && TypeChecker.CheckTypes<System.Collections.Generic.IEqualityComparer<int>>(L, 1)
            )
            {
                System.Collections.Generic.IEqualityComparer<int> arg0 =
                    (System.Collections.Generic.IEqualityComparer<int>)ToLua.ToObject(L, 1);
                System.Collections.Generic.Dictionary<int, TestAccount> obj =
                    new System.Collections.Generic.Dictionary<int, TestAccount>(arg0);
                ToLua.PushSealed(L, obj);
                return 1;
                ...
                count == 2
                && TypeChecker.CheckTypes<int, System.Collections.Generic.IEqualityComparer<int>>(
                    L,
                    1
                )
            )
            {
                int arg0 = (int)LuaDLL.lua_tonumber(L, 1);
                System.Collections.Generic.IEqualityComparer<int> arg1 =
                    (System.Collections.Generic.IEqualityComparer<int>)ToLua.ToObject(L, 2);
                System.Collections.Generic.Dictionary<int, TestAccount> obj =
                    new System.Collections.Generic.Dictionary<int, TestAccount>(arg0, arg1);
                ToLua.PushSealed(L, obj);
                return 1;
            }
            else if (
                ...
                && TypeChecker.CheckTypes<
                    System.Collections.Generic.IDictionary<int, TestAccount>,
            ...
            else
            {
                return LuaDLL.luaL_throw(
                    L,
                    "invalid arguments to ctor method: System.Collections.Generic.Dictionary<int,TestAccount>.New"
                );
            }
        }
        catch (Exception e)
        ...
        try
        {
            ...
            System.Runtime.Serialization.SerializationInfo arg0 =
                (System.Runtime.Serialization.SerializationInfo)
                    ToLua.CheckObject(L, 2, typeof(System.Runtime.Serialization.SerializationInfo));
            System.Runtime.Serialization.StreamingContext arg1 =
                StackTraits<System.Runtime.Serialization.StreamingContext>.Check(L, 3);
    ...
    static int get_Count(IntPtr L)
    {
        ...
        try
        {
            ...
            System.Collections.Generic.Dictionary<int, TestAccount> obj =
                (System.Collections.Generic.Dictionary<int, TestAccount>)o;
            int ret = obj.Count;
    ...
    static int get_Values(IntPtr L)
    {
        ...
        try
        {
            ...
            System.Collections.Generic.Dictionary<int, TestAccount> obj =
                (System.Collections.Generic.Dictionary<int, TestAccount>)o;
            System.Collections.Generic.Dictionary<int, TestAccount>.ValueCollection ret =
                obj.Values;
            ToLua.PushSealed(L, ret);
            return 1;
        }
