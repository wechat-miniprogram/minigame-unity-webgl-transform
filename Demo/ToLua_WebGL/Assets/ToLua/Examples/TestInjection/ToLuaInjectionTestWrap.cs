...
public class ToLuaInjectionTestWrap
{
        ...
        try
        {
            ...
            else
            {
                return LuaDLL.luaL_throw(
                    L,
                    "invalid arguments to ctor method: ToLuaInjectionTest.New"
                );
            }
        }
        catch (Exception e)
    ...
    static int TestRef(IntPtr L)
    {
        try
        {
            ...
            ToLuaInjectionTest obj = (ToLuaInjectionTest)
                ToLua.CheckObject<ToLuaInjectionTest>(L, 1);
    ...
    static int TestOverload(IntPtr L)
    {
        try
        {
            ...
            else
            {
                return LuaDLL.luaL_throw(
                    L,
                    "invalid arguments to method: ToLuaInjectionTest.TestOverload"
                );
            }
        }
        catch (Exception e)
