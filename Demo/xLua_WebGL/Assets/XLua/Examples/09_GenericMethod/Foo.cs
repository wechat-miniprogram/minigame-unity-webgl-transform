...
namespace XLuaTest
{
    ...
    public class Foo
    {
        ...
        public void Test1<T>(T a)
            where T : Foo1Parent
        {
            Debug.Log(string.Format("Test1<{0}>", typeof(T)));
        }

        public T1 Test2<T1, T2>(T1 a, T2 b, GameObject c)
            where T1 : Foo1Parent
            where T2 : Foo2Parent
        {
        ...
        /// </summary>
        public void UnsupportedMethod2<T>()
            where T : Foo1Parent
        {
        ...
        /// </summary>
        public void UnsupportedMethod3<T>(T a)
            where T : IDisposable
        {
    ...
    public static class FooExtension
    {
        ...
        public static T Extension1<T>(this T a)
            where T : Foo1Parent
        {
        ...
        public static T Extension2<T>(this T a, GameObject b)
            where T : Foo1Parent
        {
        ...
        public static void Extension2<T1, T2>(this T1 a, T2 b)
            where T1 : Foo1Parent
            where T2 : Foo2Parent
        {
        ...
        public static T UnsupportedExtension<T>(this GameObject obj)
            where T : Component
        {
