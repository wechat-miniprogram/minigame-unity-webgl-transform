    ...
    public class UnityEngineAnimationClipWrap
    {
        ...
        static int __CreateInstance(RealStatePtr L)
        {
            ...
            return LuaAPI.luaL_error(
                L,
                "invalid arguments to UnityEngine.AnimationClip constructor!"
            );
        }
        ...
        static int _m_SampleAnimation(RealStatePtr L)
        {
            try
            {
                ...
                UnityEngine.AnimationClip gen_to_be_invoked = (UnityEngine.AnimationClip)
                    translator.FastGetCSObj(L, 1);

                {
                    UnityEngine.GameObject _go = (UnityEngine.GameObject)
            ...
            try
            {
...

                {
                    ...
                    System.Type _type = (System.Type)
                        translator.GetObject(L, 3, typeof(System.Type));
                    string _propertyName = LuaAPI.lua_tostring(L, 4);
                    UnityEngine.AnimationCurve _curve = (UnityEngine.AnimationCurve)
        ...
        static int _m_AddEvent(RealStatePtr L)
        {
            try
            {
                ...
                {
                    UnityEngine.AnimationEvent _evt = (UnityEngine.AnimationEvent)
                        translator.GetObject(L, 2, typeof(UnityEngine.AnimationEvent));
        ...
        static int _s_set_events(RealStatePtr L)
        {
            try
            {
                ...
                UnityEngine.AnimationClip gen_to_be_invoked = (UnityEngine.AnimationClip)
                    translator.FastGetCSObj(L, 1);
                gen_to_be_invoked.events = (UnityEngine.AnimationEvent[])
                    translator.GetObject(L, 2, typeof(UnityEngine.AnimationEvent[]));
            }
            catch (System.Exception gen_e)
            {
