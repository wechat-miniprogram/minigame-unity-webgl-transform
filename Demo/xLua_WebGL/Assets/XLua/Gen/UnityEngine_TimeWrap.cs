    ...
    public class UnityEngineTimeWrap
    {
        public static void __Register(RealStatePtr L)
        {
            ...
            Utils.RegisterFunc(
                ...
                _g_get_unscaledTimeAsDouble
            );
            Utils.RegisterFunc(
                L,
                Utils.CLS_GETTER_IDX,
                "fixedUnscaledTime",
                _g_get_fixedUnscaledTime
            );
            Utils.RegisterFunc(
                L,
                Utils.CLS_GETTER_IDX,
                "fixedUnscaledTimeAsDouble",
                _g_get_fixedUnscaledTimeAsDouble
            );
            Utils.RegisterFunc(
                L,
                Utils.CLS_GETTER_IDX,
                "unscaledDeltaTime",
                _g_get_unscaledDeltaTime
            );
            Utils.RegisterFunc(
                L,
                Utils.CLS_GETTER_IDX,
                "fixedUnscaledDeltaTime",
                _g_get_fixedUnscaledDeltaTime
            );
            ...
            Utils.RegisterFunc(
                ...
                _g_get_maximumParticleDeltaTime
            );
            ...
            Utils.RegisterFunc(
                ...
                Utils.CLS_GETTER_IDX,
                "renderedFrameCount",
                _g_get_renderedFrameCount
            );
            Utils.RegisterFunc(
                L,
                Utils.CLS_GETTER_IDX,
                "realtimeSinceStartup",
                _g_get_realtimeSinceStartup
            );
            Utils.RegisterFunc(
                L,
                Utils.CLS_GETTER_IDX,
            ...
            Utils.RegisterFunc(
                ...
                Utils.CLS_GETTER_IDX,
                "captureDeltaTime",
                _g_get_captureDeltaTime
            );
            Utils.RegisterFunc(
                L,
                Utils.CLS_GETTER_IDX,
                "captureFramerate",
                _g_get_captureFramerate
            );
            ...
            Utils.RegisterFunc(
                ...
                "maximumDeltaTime",
                _s_set_maximumDeltaTime
            );
            Utils.RegisterFunc(
                L,
                Utils.CLS_SETTER_IDX,
                "maximumParticleDeltaTime",
                _s_set_maximumParticleDeltaTime
            );
            ...
            Utils.RegisterFunc(
                ...
                Utils.CLS_SETTER_IDX,
                "captureDeltaTime",
                _s_set_captureDeltaTime
            );
            Utils.RegisterFunc(
                L,
                Utils.CLS_SETTER_IDX,
                "captureFramerate",
                _s_set_captureFramerate
            );
