    ...
    public class UnityEngineObjectWrap
    {
        public static void __Register(RealStatePtr L)
        {
            ...
            Utils.RegisterFunc(
                ...
                Utils.CLS_IDX,
                "FindObjectsOfType",
                _m_FindObjectsOfType_xlua_st_
            );
            Utils.RegisterFunc(
                L,
                Utils.CLS_IDX,
                "DontDestroyOnLoad",
                _m_DontDestroyOnLoad_xlua_st_
            );
        ...
        static int __EqMeta(RealStatePtr L)
        {
            try
            {
                ...
                {
                    UnityEngine.Object leftside = (UnityEngine.Object)
                        translator.GetObject(L, 1, typeof(UnityEngine.Object));
                    UnityEngine.Object rightside = (UnityEngine.Object)
            ...
            return LuaAPI.luaL_error(
                L,
                "invalid arguments to right hand of == operator, need UnityEngine.Object!"
            );
        }
        ...
        static int _m_GetInstanceID(RealStatePtr L)
        {
            try
            {
                ...
                UnityEngine.Object gen_to_be_invoked = (UnityEngine.Object)
        ...
        static int _m_Instantiate_xlua_st_(RealStatePtr L)
        {
            try
            {
                ...
                {
                    UnityEngine.Object _original = (UnityEngine.Object)
                        translator.GetObject(L, 1, typeof(UnityEngine.Object));
                ...
                )
                {
                    ...
                    var gen_ret = UnityEngine.Object.Instantiate(
                        _original,
                        _parent,
                ...
                if (
                    ...
                    && translator.Assignable<UnityEngine.Quaternion>(L, 3)
                )
                {
                    UnityEngine.Object _original = (UnityEngine.Object)
                        translator.GetObject(L, 1, typeof(UnityEngine.Object));
                ...
                if (
                    ...
                    && translator.Assignable<UnityEngine.Vector3>(L, 2)
                    && translator.Assignable<UnityEngine.Quaternion>(L, 3)
                    && translator.Assignable<UnityEngine.Transform>(L, 4)
                )
                {
                    UnityEngine.Object _original = (UnityEngine.Object)
                        translator.GetObject(L, 1, typeof(UnityEngine.Object));
                    ...
                    translator.Get(L, 3, out _rotation);
                    UnityEngine.Transform _parent = (UnityEngine.Transform)
                        translator.GetObject(L, 4, typeof(UnityEngine.Transform));
        ...
        static int _m_Destroy_xlua_st_(RealStatePtr L)
        {
            try
            {
                ...
                if (gen_param_count == 1 && translator.Assignable<UnityEngine.Object>(L, 1))
                {
                    UnityEngine.Object _obj = (UnityEngine.Object)
                        translator.GetObject(L, 1, typeof(UnityEngine.Object));
        ...
        static int _m_DestroyImmediate_xlua_st_(RealStatePtr L)
        {
            ...
            return LuaAPI.luaL_error(
                L,
                "invalid arguments to UnityEngine.Object.DestroyImmediate!"
            );
        }
        ...
        static int _m_FindObjectsOfType_xlua_st_(RealStatePtr L)
        {
            try
            {
                ...
                if (gen_param_count == 1 && translator.Assignable<System.Type>(L, 1))
                {
                    System.Type _type = (System.Type)
                        translator.GetObject(L, 1, typeof(System.Type));
                ...
                if (
                    gen_param_count == 2
                    && translator.Assignable<System.Type>(L, 1)
                    && LuaTypes.LUA_TBOOLEAN == LuaAPI.lua_type(L, 2)
                )
                {
                    System.Type _type = (System.Type)
            ...
            return LuaAPI.luaL_error(
                L,
                "invalid arguments to UnityEngine.Object.FindObjectsOfType!"
            );
        }
        ...
        static int _m_DontDestroyOnLoad_xlua_st_(RealStatePtr L)
        {
            try
            {
                ...
                {
                    UnityEngine.Object _target = (UnityEngine.Object)
                        translator.GetObject(L, 1, typeof(UnityEngine.Object));
        ...
        static int _m_FindObjectOfType_xlua_st_(RealStatePtr L)
        {
            ...
            return LuaAPI.luaL_error(
                L,
                "invalid arguments to UnityEngine.Object.FindObjectOfType!"
            );
        }
        ...
        static int _s_set_hideFlags(RealStatePtr L)
        {
            try
            {
                ...
                UnityEngine.Object gen_to_be_invoked = (UnityEngine.Object)
                    translator.FastGetCSObj(L, 1);
                UnityEngine.HideFlags gen_value;
