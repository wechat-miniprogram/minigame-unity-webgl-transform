    ...
    public class UnityEngineLightWrap
    {
        public static void __Register(RealStatePtr L)
        {
            ...
            Utils.RegisterFunc(
                ...
                _m_RemoveCommandBuffers
            );
            Utils.RegisterFunc(
                L,
                Utils.METHOD_IDX,
                "RemoveAllCommandBuffers",
                _m_RemoveAllCommandBuffers
            );
            ...
            Utils.RegisterFunc(
                ...
                _g_get_useBoundingSphereOverride
            );
            Utils.RegisterFunc(
                L,
                Utils.GETTER_IDX,
                "boundingSphereOverride",
                _g_get_boundingSphereOverride
            );
            Utils.RegisterFunc(
                L,
                Utils.GETTER_IDX,
                "useViewFrustumForShadowCasterCull",
                _g_get_useViewFrustumForShadowCasterCull
            );
            Utils.RegisterFunc(
                L,
                Utils.GETTER_IDX,
                "shadowCustomResolution",
                _g_get_shadowCustomResolution
            );
            ...
            Utils.RegisterFunc(
                ...
                Utils.GETTER_IDX,
                "renderingLayerMask",
                _g_get_renderingLayerMask
            );
            Utils.RegisterFunc(
                L,
                Utils.GETTER_IDX,
                "lightShadowCasterMode",
                _g_get_lightShadowCasterMode
            );
            ...
            Utils.RegisterFunc(
                ...
                _g_get_layerShadowCullDistances
            );
            ...
            Utils.RegisterFunc(
                ...
                Utils.SETTER_IDX,
                "useBoundingSphereOverride",
                _s_set_useBoundingSphereOverride
            );
            Utils.RegisterFunc(
                L,
                Utils.SETTER_IDX,
                "boundingSphereOverride",
                _s_set_boundingSphereOverride
            );
            Utils.RegisterFunc(
                L,
                Utils.SETTER_IDX,
                "useViewFrustumForShadowCasterCull",
                _s_set_useViewFrustumForShadowCasterCull
            );
            Utils.RegisterFunc(
                L,
                Utils.SETTER_IDX,
                "shadowCustomResolution",
                _s_set_shadowCustomResolution
            );
            ...
            Utils.RegisterFunc(
                ...
                Utils.SETTER_IDX,
                "useShadowMatrixOverride",
                _s_set_useShadowMatrixOverride
            );
            Utils.RegisterFunc(
                L,
                Utils.SETTER_IDX,
                "shadowMatrixOverride",
                _s_set_shadowMatrixOverride
            );
            ...
            Utils.RegisterFunc(
                ...
                Utils.SETTER_IDX,
                "renderingLayerMask",
                _s_set_renderingLayerMask
            );
            Utils.RegisterFunc(
                L,
                Utils.SETTER_IDX,
                "lightShadowCasterMode",
                _s_set_lightShadowCasterMode
            );
            ...
            Utils.RegisterFunc(
                ...
                Utils.SETTER_IDX,
                "layerShadowCullDistances",
                _s_set_layerShadowCullDistances
            );
        ...
        static int _m_Reset(RealStatePtr L)
        {
            try
            {
                ...
                UnityEngine.Light gen_to_be_invoked = (UnityEngine.Light)
        ...
        static int _m_AddCommandBuffer(RealStatePtr L)
        {
            try
            {
                ...
                if (
                    gen_param_count == 3
                    && translator.Assignable<UnityEngine.Rendering.LightEvent>(L, 2)
                    && translator.Assignable<UnityEngine.Rendering.CommandBuffer>(L, 3)
                )
                {
                    UnityEngine.Rendering.LightEvent _evt;
                    translator.Get(L, 2, out _evt);
                    UnityEngine.Rendering.CommandBuffer _buffer =
                        (UnityEngine.Rendering.CommandBuffer)
                            translator.GetObject(L, 3, typeof(UnityEngine.Rendering.CommandBuffer));
                ...
                if (
                    ...
                    && translator.Assignable<UnityEngine.Rendering.LightEvent>(L, 2)
                    && translator.Assignable<UnityEngine.Rendering.CommandBuffer>(L, 3)
                    && translator.Assignable<UnityEngine.Rendering.ShadowMapPass>(L, 4)
                )
                {
                    UnityEngine.Rendering.LightEvent _evt;
                    translator.Get(L, 2, out _evt);
                    UnityEngine.Rendering.CommandBuffer _buffer =
                        (UnityEngine.Rendering.CommandBuffer)
                            translator.GetObject(L, 3, typeof(UnityEngine.Rendering.CommandBuffer));
                    UnityEngine.Rendering.ShadowMapPass _shadowPassMask;
                    translator.Get(L, 4, out _shadowPassMask);
        ...
        static int _m_AddCommandBufferAsync(RealStatePtr L)
        {
            try
            {
                ...
                if (
                    ...
                    && translator.Assignable<UnityEngine.Rendering.LightEvent>(L, 2)
                    && translator.Assignable<UnityEngine.Rendering.CommandBuffer>(L, 3)
                    && translator.Assignable<UnityEngine.Rendering.ComputeQueueType>(L, 4)
                )
                {
                    UnityEngine.Rendering.LightEvent _evt;
                    translator.Get(L, 2, out _evt);
                    UnityEngine.Rendering.CommandBuffer _buffer =
                        (UnityEngine.Rendering.CommandBuffer)
                            translator.GetObject(L, 3, typeof(UnityEngine.Rendering.CommandBuffer));
                    UnityEngine.Rendering.ComputeQueueType _queueType;
                    translator.Get(L, 4, out _queueType);
                ...
                if (
                    ...
                    && translator.Assignable<UnityEngine.Rendering.CommandBuffer>(L, 3)
                    && translator.Assignable<UnityEngine.Rendering.ShadowMapPass>(L, 4)
                    && translator.Assignable<UnityEngine.Rendering.ComputeQueueType>(L, 5)
                )
                {
                    UnityEngine.Rendering.LightEvent _evt;
                    translator.Get(L, 2, out _evt);
                    ...
                    translator.Get(L, 4, out _shadowPassMask);
                    UnityEngine.Rendering.ComputeQueueType _queueType;
                    translator.Get(L, 5, out _queueType);
            ...
            return LuaAPI.luaL_error(
                L,
                "invalid arguments to UnityEngine.Light.AddCommandBufferAsync!"
            );
        }
        ...
        static int _s_set_type(RealStatePtr L)
        {
            try
            {
                ...
                UnityEngine.Light gen_to_be_invoked = (UnityEngine.Light)
                    translator.FastGetCSObj(L, 1);
                UnityEngine.LightType gen_value;
        ...
        static int _s_set_shape(RealStatePtr L)
        {
            try
            {
                ...
                UnityEngine.Light gen_to_be_invoked = (UnityEngine.Light)
                    translator.FastGetCSObj(L, 1);
                UnityEngine.LightShape gen_value;
                translator.Get(L, 2, out gen_value);
        ...
        static int _s_set_shadowMatrixOverride(RealStatePtr L)
        {
            try
            {
                ...
                UnityEngine.Light gen_to_be_invoked = (UnityEngine.Light)
                    translator.FastGetCSObj(L, 1);
                UnityEngine.Matrix4x4 gen_value;
                translator.Get(L, 2, out gen_value);
        ...
        static int _s_set_flare(RealStatePtr L)
        {
            try
            {
                ...
                UnityEngine.Light gen_to_be_invoked = (UnityEngine.Light)
                    translator.FastGetCSObj(L, 1);
                gen_to_be_invoked.flare = (UnityEngine.Flare)
                    translator.GetObject(L, 2, typeof(UnityEngine.Flare));
            }
            catch (System.Exception gen_e)
            {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
        ...
        static int _s_set_bakingOutput(RealStatePtr L)
        {
            try
            {
                ...
                UnityEngine.Light gen_to_be_invoked = (UnityEngine.Light)
                    translator.FastGetCSObj(L, 1);
                UnityEngine.LightBakingOutput gen_value;
                translator.Get(L, 2, out gen_value);
        ...
        static int _s_set_lightShadowCasterMode(RealStatePtr L)
        {
            try
            {
                ...
                UnityEngine.Light gen_to_be_invoked = (UnityEngine.Light)
                    translator.FastGetCSObj(L, 1);
                UnityEngine.LightShadowCasterMode gen_value;
                translator.Get(L, 2, out gen_value);
        ...
        static int _s_set_shadows(RealStatePtr L)
        {
            try
            {
                ...
                UnityEngine.Light gen_to_be_invoked = (UnityEngine.Light)
                    translator.FastGetCSObj(L, 1);
                UnityEngine.LightShadows gen_value;
                translator.Get(L, 2, out gen_value);
        ...
        static int _s_set_shadowResolution(RealStatePtr L)
        {
            try
            {
                ...
                UnityEngine.Light gen_to_be_invoked = (UnityEngine.Light)
                    translator.FastGetCSObj(L, 1);
                UnityEngine.Rendering.LightShadowResolution gen_value;
                translator.Get(L, 2, out gen_value);
        ...
        static int _s_set_layerShadowCullDistances(RealStatePtr L)
        {
            try
            {
                ...
                UnityEngine.Light gen_to_be_invoked = (UnityEngine.Light)
                    translator.FastGetCSObj(L, 1);
                gen_to_be_invoked.layerShadowCullDistances = (float[])
                    translator.GetObject(L, 2, typeof(float[]));
            }
            catch (System.Exception gen_e)
            {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
        ...
        static int _s_set_cookie(RealStatePtr L)
        {
            try
            {
                ...
                UnityEngine.Light gen_to_be_invoked = (UnityEngine.Light)
                    translator.FastGetCSObj(L, 1);
                gen_to_be_invoked.cookie = (UnityEngine.Texture)
                    translator.GetObject(L, 2, typeof(UnityEngine.Texture));
            }
            catch (System.Exception gen_e)
            {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
        ...
        static int _s_set_renderMode(RealStatePtr L)
        {
            try
            {
                ...
                UnityEngine.Light gen_to_be_invoked = (UnityEngine.Light)
                    translator.FastGetCSObj(L, 1);
                UnityEngine.LightRenderMode gen_value;
                translator.Get(L, 2, out gen_value);
