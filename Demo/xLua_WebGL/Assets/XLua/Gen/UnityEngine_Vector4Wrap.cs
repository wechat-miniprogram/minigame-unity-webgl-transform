    ...
    public class UnityEngineVector4Wrap
    {
        ...
        public static int __CSIndexer(RealStatePtr L)
        {
            try
            {
                ...
                if (
                    translator.Assignable<UnityEngine.Vector4>(L, 1)
                    && LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2)
                )
                {
                    UnityEngine.Vector4 gen_to_be_invoked;
        ...
        static int __AddMeta(RealStatePtr L)
        {
            try
            {
                ...
                if (
                    translator.Assignable<UnityEngine.Vector4>(L, 1)
                    && translator.Assignable<UnityEngine.Vector4>(L, 2)
                )
                {
                    UnityEngine.Vector4 leftside;
                    translator.Get(L, 1, out leftside);
                    UnityEngine.Vector4 rightside;
            ...
            return LuaAPI.luaL_error(
                L,
                "invalid arguments to right hand of + operator, need UnityEngine.Vector4!"
            );
        }
        ...
        static int _m_Lerp_xlua_st_(RealStatePtr L)
        {
            try
            {
                ...
                {
                    UnityEngine.Vector4 _a;
                    translator.Get(L, 1, out _a);
                    UnityEngine.Vector4 _b;
        ...
        static int _m_Min_xlua_st_(RealStatePtr L)
        {
            try
            {
                ...
                {
                    UnityEngine.Vector4 _lhs;
                    translator.Get(L, 1, out _lhs);
                    UnityEngine.Vector4 _rhs;
