    ...
    public class TutorialDerivedClassWrap
    {
        public static void __Register(RealStatePtr L)
        {
            ...
            Utils.RegisterFunc(
                L,
                Utils.METHOD_IDX,
                "GenericMethodOfString",
                _m_GenericMethodOfString
            );
        ...
        static int __AddMeta(RealStatePtr L)
        {
            try
            {
                ...
                if (
                    translator.Assignable<Tutorial.DerivedClass>(L, 1)
                    && translator.Assignable<Tutorial.DerivedClass>(L, 2)
                )
                {
                    Tutorial.DerivedClass leftside = (Tutorial.DerivedClass)
                        translator.GetObject(L, 1, typeof(Tutorial.DerivedClass));
                    Tutorial.DerivedClass rightside = (Tutorial.DerivedClass)
                        translator.GetObject(L, 2, typeof(Tutorial.DerivedClass));
            ...
            return LuaAPI.luaL_error(
                L,
                "invalid arguments to right hand of + operator, need Tutorial.DerivedClass!"
            );
        }
        ...
        static int _m_DMFunc(RealStatePtr L)
        {
            try
            {
                ...
                Tutorial.DerivedClass gen_to_be_invoked = (Tutorial.DerivedClass)
        ...
        static int _m_DefaultValueFunc(RealStatePtr L)
        {
            ...
            return LuaAPI.luaL_error(
                L,
                "invalid arguments to Tutorial.DerivedClass.DefaultValueFunc!"
            );
        }
        ...
        static int _s_set_TestDelegate(RealStatePtr L)
        {
            try
            {
                ...
                Tutorial.DerivedClass gen_to_be_invoked = (Tutorial.DerivedClass)
                    translator.FastGetCSObj(L, 1);
                gen_to_be_invoked.TestDelegate = translator.GetDelegate<System.Action<string>>(
                    L,
                    2
                );
            }
