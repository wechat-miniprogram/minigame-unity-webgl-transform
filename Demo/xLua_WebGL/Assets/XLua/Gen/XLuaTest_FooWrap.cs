    ...
    public class XLuaTestFooWrap
    {
        ...
        static int _m_Test1(RealStatePtr L)
        {
            try
            {
                ...
                {
                    XLuaTest.Foo1Parent _a = (XLuaTest.Foo1Parent)
                        translator.GetObject(L, 2, typeof(XLuaTest.Foo1Parent));
        ...
        static int _m_Test2(RealStatePtr L)
        {
            try
            {
...

                {
                    XLuaTest.Foo1Parent _a = (XLuaTest.Foo1Parent)
                        translator.GetObject(L, 2, typeof(XLuaTest.Foo1Parent));
                    XLuaTest.Foo2Parent _b = (XLuaTest.Foo2Parent)
                        translator.GetObject(L, 3, typeof(XLuaTest.Foo2Parent));
                    UnityEngine.GameObject _c = (UnityEngine.GameObject)
                        translator.GetObject(L, 4, typeof(UnityEngine.GameObject));
