    ...
    public class UnityEngineVector2Wrap
    {
        ...
        public static int __CSIndexer(RealStatePtr L)
        {
            try
            {
                ...
                if (
                    translator.Assignable<UnityEngine.Vector2>(L, 1)
                    && LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2)
                )
                {
                    UnityEngine.Vector2 gen_to_be_invoked;
        ...
        static int __AddMeta(RealStatePtr L)
        {
            try
            {
                ...
                if (
                    translator.Assignable<UnityEngine.Vector2>(L, 1)
                    && translator.Assignable<UnityEngine.Vector2>(L, 2)
                )
                {
                    UnityEngine.Vector2 leftside;
                    translator.Get(L, 1, out leftside);
                    UnityEngine.Vector2 rightside;
            ...
            return LuaAPI.luaL_error(
                L,
                "invalid arguments to right hand of + operator, need UnityEngine.Vector2!"
            );
        }
        ...
        static int _m_Lerp_xlua_st_(RealStatePtr L)
        {
            try
            {
                ...
                {
                    UnityEngine.Vector2 _a;
                    translator.Get(L, 1, out _a);
                    UnityEngine.Vector2 _b;
        ...
        static int _m_Reflect_xlua_st_(RealStatePtr L)
        {
            try
            {
                ...
                {
                    UnityEngine.Vector2 _inDirection;
                    translator.Get(L, 1, out _inDirection);
                    UnityEngine.Vector2 _inNormal;
        ...
        static int _m_Dot_xlua_st_(RealStatePtr L)
        {
            try
            {
                ...
                {
                    UnityEngine.Vector2 _lhs;
                    translator.Get(L, 1, out _lhs);
                    UnityEngine.Vector2 _rhs;
        ...
        static int _m_Angle_xlua_st_(RealStatePtr L)
        {
            try
            {
                ...
                {
                    UnityEngine.Vector2 _from;
                    translator.Get(L, 1, out _from);
                    UnityEngine.Vector2 _to;
        ...
        static int _m_SmoothDamp_xlua_st_(RealStatePtr L)
        {
            try
            {
                ...
                if (
                    ...
                    && translator.Assignable<UnityEngine.Vector2>(L, 1)
                    && translator.Assignable<UnityEngine.Vector2>(L, 2)
                    && translator.Assignable<UnityEngine.Vector2>(L, 3)
