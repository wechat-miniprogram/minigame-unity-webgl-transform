    ...
    public class UnityEngineBoundsWrap
    {
        ...
        static int __CreateInstance(RealStatePtr L)
        {
            try
            {
                ...
                )
                {
                    ...
                    translator.Get(L, 2, out _center);
                    UnityEngine.Vector3 _size;
                    translator.Get(L, 3, out _size);
        ...
        static int __EqMeta(RealStatePtr L)
        {
            try
            {
                ...
                if (
                    translator.Assignable<UnityEngine.Bounds>(L, 1)
                    && translator.Assignable<UnityEngine.Bounds>(L, 2)
                )
                {
                    UnityEngine.Bounds leftside;
                    translator.Get(L, 1, out leftside);
                    UnityEngine.Bounds rightside;
            ...
            return LuaAPI.luaL_error(
                L,
                "invalid arguments to right hand of == operator, need UnityEngine.Bounds!"
            );
        }
        ...
        static int _m_GetHashCode(RealStatePtr L)
        {
            try
            {
                ...
                UnityEngine.Bounds gen_to_be_invoked;
        ...
        static int _m_SetMinMax(RealStatePtr L)
        {
            try
            {
...

                {
                    ...
                    translator.Get(L, 2, out _min);
                    UnityEngine.Vector3 _max;
                    translator.Get(L, 3, out _max);
        ...
        static int _m_Encapsulate(RealStatePtr L)
        {
            try
            {
                ...
                if (gen_param_count == 2 && translator.Assignable<UnityEngine.Bounds>(L, 2))
                {
                    ...
                    translator.Get(L, 2, out _bounds);
        ...
        static int _m_Expand(RealStatePtr L)
        {
            try
            {
                ...
                if (gen_param_count == 2 && translator.Assignable<UnityEngine.Vector3>(L, 2))
                {
                    UnityEngine.Vector3 _amount;
                    translator.Get(L, 2, out _amount);
        ...
        static int _m_IntersectRay(RealStatePtr L)
        {
            try
            {
                ...
                {
                    UnityEngine.Ray _ray;
                    translator.Get(L, 2, out _ray);
