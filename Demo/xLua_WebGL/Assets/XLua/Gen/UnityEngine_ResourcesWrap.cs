    ...
    public class UnityEngineResourcesWrap
    {
        public static void __Register(RealStatePtr L)
        {
            ...
            Utils.RegisterFunc(
                ...
                _m_FindObjectsOfTypeAll_xlua_st_
            );
            ...
            Utils.RegisterFunc(
                ...
                Utils.CLS_IDX,
                "GetBuiltinResource",
                _m_GetBuiltinResource_xlua_st_
            );
            ...
            Utils.RegisterFunc(
                ...
                Utils.CLS_IDX,
                "UnloadUnusedAssets",
                _m_UnloadUnusedAssets_xlua_st_
            );
            Utils.RegisterFunc(
                L,
                Utils.CLS_IDX,
        ...
        static int _m_Load_xlua_st_(RealStatePtr L)
        {
            try
            {
                ...
                {
                    string _path = LuaAPI.lua_tostring(L, 1);
                    System.Type _systemTypeInstance = (System.Type)
        ...
        static int _m_UnloadAsset_xlua_st_(RealStatePtr L)
        {
            try
            {
                ...
                {
                    UnityEngine.Object _assetToUnload = (UnityEngine.Object)
        ...
        static int _m_InstanceIDToObjectList_xlua_st_(RealStatePtr L)
        {
            try
            {
                ...
                {
                    Unity.Collections.NativeArray<int> _instanceIDs;
                    translator.Get(L, 1, out _instanceIDs);
                    System.Collections.Generic.List<UnityEngine.Object> _objects =
