    ...
    public class UnityEngineMonoBehaviourWrap
    {
        ...
        static int __CreateInstance(RealStatePtr L)
        {
            ...
            return LuaAPI.luaL_error(
                L,
                "invalid arguments to UnityEngine.MonoBehaviour constructor!"
            );
        }
        ...
        static int _m_IsInvoking(RealStatePtr L)
        {
            try
            {
                ...
                UnityEngine.MonoBehaviour gen_to_be_invoked = (UnityEngine.MonoBehaviour)
            ...
            return LuaAPI.luaL_error(
                L,
                "invalid arguments to UnityEngine.MonoBehaviour.IsInvoking!"
            );
        }
        ...
        static int _m_CancelInvoke(RealStatePtr L)
        {
            ...
            return LuaAPI.luaL_error(
                L,
                "invalid arguments to UnityEngine.MonoBehaviour.CancelInvoke!"
            );
        }
        ...
        static int _m_StartCoroutine(RealStatePtr L)
        {
            try
            {
                ...
                if (
                    gen_param_count == 2
                    && translator.Assignable<System.Collections.IEnumerator>(L, 2)
                )
                {
                    System.Collections.IEnumerator _routine = (System.Collections.IEnumerator)
                        translator.GetObject(L, 2, typeof(System.Collections.IEnumerator));
            ...
            return LuaAPI.luaL_error(
                L,
                "invalid arguments to UnityEngine.MonoBehaviour.StartCoroutine!"
            );
        }
        ...
        static int _m_StopCoroutine(RealStatePtr L)
        {
            try
            {
                ...
                {
                    UnityEngine.Coroutine _routine = (UnityEngine.Coroutine)
                        translator.GetObject(L, 2, typeof(UnityEngine.Coroutine));
            ...
            return LuaAPI.luaL_error(
                L,
                "invalid arguments to UnityEngine.MonoBehaviour.StopCoroutine!"
            );
        }
