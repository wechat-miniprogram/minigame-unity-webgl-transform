        ...
        static int __CastFrom(RealStatePtr L)
        {
            ...
            else
            {
                return LuaAPI.luaL_error(
                    L,
                    "invalid lua type for Tutorial.TestEnum! Expect number or string, got + "
                        + lua_type
                );
            }
    ...
    public class XLuaTestMyEnumWrap
    {
        ...
        static int __CastFrom(RealStatePtr L)
        {
            ...
            else
            {
                return LuaAPI.luaL_error(
                    L,
                    "invalid lua type for XLuaTest.MyEnum! Expect number or string, got + "
                        + lua_type
                );
            }
    ...
    public class TutorialDerivedClassTestEnumInnerWrap
    {
        public static void __Register(RealStatePtr L)
        {
            ...
            Utils.RegisterObject(
                ...
                Utils.CLS_IDX,
                "E3",
                Tutorial.DerivedClass.TestEnumInner.E3
            );
            ...
            Utils.RegisterObject(
                ...
                Utils.CLS_IDX,
                "E4",
                Tutorial.DerivedClass.TestEnumInner.E4
            );
        ...
        static int __CastFrom(RealStatePtr L)
        {
            ...
            if (lua_type == LuaTypes.LUA_TNUMBER)
            {
                translator.PushTutorialDerivedClassTestEnumInner(
                    L,
                    (Tutorial.DerivedClass.TestEnumInner)LuaAPI.xlua_tointeger(L, 1)
                );
            }
            else if (lua_type == LuaTypes.LUA_TSTRING)
            {
                ...
                else
                {
                    return LuaAPI.luaL_error(
                        L,
                        "invalid string for Tutorial.DerivedClass.TestEnumInner!"
                    );
                }
            }
            else
            {
                return LuaAPI.luaL_error(
                    L,
                    "invalid lua type for Tutorial.DerivedClass.TestEnumInner! Expect number or string, got + "
                        + lua_type
                );
            }
