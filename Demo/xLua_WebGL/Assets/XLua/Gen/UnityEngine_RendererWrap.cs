    ...
    public class UnityEngineRendererWrap
    {
        public static void __Register(RealStatePtr L)
        {
            ...
            Utils.RegisterFunc(
                ...
                _g_get_allowOcclusionWhenDynamic
            );
            Utils.RegisterFunc(
                L,
                Utils.GETTER_IDX,
                "isPartOfStaticBatch",
                _g_get_isPartOfStaticBatch
            );
            Utils.RegisterFunc(
                L,
                Utils.GETTER_IDX,
            ...
            Utils.RegisterFunc(
                ...
                _g_get_lightProbeProxyVolumeOverride
            );
            ...
            Utils.RegisterFunc(
                ...
                _g_get_realtimeLightmapIndex
            );
            Utils.RegisterFunc(
                L,
                Utils.GETTER_IDX,
                "lightmapScaleOffset",
                _g_get_lightmapScaleOffset
            );
            Utils.RegisterFunc(
                L,
                Utils.GETTER_IDX,
                "realtimeLightmapScaleOffset",
                _g_get_realtimeLightmapScaleOffset
            );
            ...
            Utils.RegisterFunc(
                ...
                Utils.SETTER_IDX,
                "staticShadowCaster",
                _s_set_staticShadowCaster
            );
            Utils.RegisterFunc(
                L,
                Utils.SETTER_IDX,
                "motionVectorGenerationMode",
                _s_set_motionVectorGenerationMode
            );
            ...
            Utils.RegisterFunc(
                ...
                Utils.SETTER_IDX,
                "allowOcclusionWhenDynamic",
                _s_set_allowOcclusionWhenDynamic
            );
            Utils.RegisterFunc(
                L,
                Utils.SETTER_IDX,
                "lightProbeProxyVolumeOverride",
                _s_set_lightProbeProxyVolumeOverride
            );
            ...
            Utils.RegisterFunc(
                ...
                Utils.SETTER_IDX,
                "realtimeLightmapIndex",
                _s_set_realtimeLightmapIndex
            );
            Utils.RegisterFunc(
                L,
                Utils.SETTER_IDX,
                "lightmapScaleOffset",
                _s_set_lightmapScaleOffset
            );
            Utils.RegisterFunc(
                L,
                Utils.SETTER_IDX,
                "realtimeLightmapScaleOffset",
                _s_set_realtimeLightmapScaleOffset
            );
        ...
        static int _m_ResetBounds(RealStatePtr L)
        {
            try
            {
                ...
                UnityEngine.Renderer gen_to_be_invoked = (UnityEngine.Renderer)
        ...
        static int _m_SetPropertyBlock(RealStatePtr L)
        {
            try
            {
                ...
                if (
                    gen_param_count == 2
                    && translator.Assignable<UnityEngine.MaterialPropertyBlock>(L, 2)
                )
                {
                    UnityEngine.MaterialPropertyBlock _properties =
                        (UnityEngine.MaterialPropertyBlock)
                            translator.GetObject(L, 2, typeof(UnityEngine.MaterialPropertyBlock));
            ...
            return LuaAPI.luaL_error(
                L,
                "invalid arguments to UnityEngine.Renderer.SetPropertyBlock!"
            );
        }
        ...
        static int _m_GetPropertyBlock(RealStatePtr L)
        {
            ...
            return LuaAPI.luaL_error(
                L,
                "invalid arguments to UnityEngine.Renderer.GetPropertyBlock!"
            );
        }
        ...
        static int _m_GetMaterials(RealStatePtr L)
        {
            try
            {
                ...
                {
                    System.Collections.Generic.List<UnityEngine.Material> _m =
                        (System.Collections.Generic.List<UnityEngine.Material>)
                            translator.GetObject(
                                L,
                                2,
                                typeof(System.Collections.Generic.List<UnityEngine.Material>)
                            );
        ...
        static int _m_GetClosestReflectionProbes(RealStatePtr L)
        {
            try
            {
                ...
                {
                    System.Collections.Generic.List<UnityEngine.Rendering.ReflectionProbeBlendInfo> _result =
        ...
        static int _s_set_shadowCastingMode(RealStatePtr L)
        {
            try
            {
                ...
                UnityEngine.Renderer gen_to_be_invoked = (UnityEngine.Renderer)
                    translator.FastGetCSObj(L, 1);
                UnityEngine.Rendering.ShadowCastingMode gen_value;
                translator.Get(L, 2, out gen_value);
        ...
        static int _s_set_motionVectorGenerationMode(RealStatePtr L)
        {
            try
            {
                ...
                UnityEngine.Renderer gen_to_be_invoked = (UnityEngine.Renderer)
                    translator.FastGetCSObj(L, 1);
                UnityEngine.MotionVectorGenerationMode gen_value;
                translator.Get(L, 2, out gen_value);
        ...
        static int _s_set_lightProbeUsage(RealStatePtr L)
        {
            try
            {
                ...
                UnityEngine.Renderer gen_to_be_invoked = (UnityEngine.Renderer)
                    translator.FastGetCSObj(L, 1);
                UnityEngine.Rendering.LightProbeUsage gen_value;
                translator.Get(L, 2, out gen_value);
        ...
        static int _s_set_reflectionProbeUsage(RealStatePtr L)
        {
            try
            {
                ...
                UnityEngine.Renderer gen_to_be_invoked = (UnityEngine.Renderer)
                    translator.FastGetCSObj(L, 1);
                UnityEngine.Rendering.ReflectionProbeUsage gen_value;
                translator.Get(L, 2, out gen_value);
        ...
        static int _s_set_rayTracingMode(RealStatePtr L)
        {
            try
            {
                ...
                UnityEngine.Renderer gen_to_be_invoked = (UnityEngine.Renderer)
                    translator.FastGetCSObj(L, 1);
                UnityEngine.Experimental.Rendering.RayTracingMode gen_value;
                translator.Get(L, 2, out gen_value);
        ...
        static int _s_set_lightProbeProxyVolumeOverride(RealStatePtr L)
        {
            try
            {
                ...
                UnityEngine.Renderer gen_to_be_invoked = (UnityEngine.Renderer)
                    translator.FastGetCSObj(L, 1);
                gen_to_be_invoked.lightProbeProxyVolumeOverride = (UnityEngine.GameObject)
                    translator.GetObject(L, 2, typeof(UnityEngine.GameObject));
            }
            catch (System.Exception gen_e)
            {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
        ...
        static int _s_set_probeAnchor(RealStatePtr L)
        {
            try
            {
                ...
                UnityEngine.Renderer gen_to_be_invoked = (UnityEngine.Renderer)
                    translator.FastGetCSObj(L, 1);
                gen_to_be_invoked.probeAnchor = (UnityEngine.Transform)
        ...
        static int _s_set_materials(RealStatePtr L)
        {
            try
            {
                ...
                UnityEngine.Renderer gen_to_be_invoked = (UnityEngine.Renderer)
                    translator.FastGetCSObj(L, 1);
                gen_to_be_invoked.materials = (UnityEngine.Material[])
                    translator.GetObject(L, 2, typeof(UnityEngine.Material[]));
            }
            catch (System.Exception gen_e)
            {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
        ...
        static int _s_set_material(RealStatePtr L)
        {
            try
            {
                ...
                UnityEngine.Renderer gen_to_be_invoked = (UnityEngine.Renderer)
                    translator.FastGetCSObj(L, 1);
                gen_to_be_invoked.material = (UnityEngine.Material)
                    translator.GetObject(L, 2, typeof(UnityEngine.Material));
            }
            catch (System.Exception gen_e)
            {
        ...
        static int _s_set_sharedMaterial(RealStatePtr L)
        {
            try
            {
                ...
                UnityEngine.Renderer gen_to_be_invoked = (UnityEngine.Renderer)
                    translator.FastGetCSObj(L, 1);
                gen_to_be_invoked.sharedMaterial = (UnityEngine.Material)
                    translator.GetObject(L, 2, typeof(UnityEngine.Material));
            }
            catch (System.Exception gen_e)
            {
        ...
        static int _s_set_sharedMaterials(RealStatePtr L)
        {
            try
            {
                ...
                UnityEngine.Renderer gen_to_be_invoked = (UnityEngine.Renderer)
                    translator.FastGetCSObj(L, 1);
                gen_to_be_invoked.sharedMaterials = (UnityEngine.Material[])
                    translator.GetObject(L, 2, typeof(UnityEngine.Material[]));
            }
            catch (System.Exception gen_e)
            {
