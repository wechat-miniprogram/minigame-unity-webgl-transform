    ...
    public class UnityEngineParticleSystemWrap
    {
        public static void __Register(RealStatePtr L)
        {
            ...
            Utils.RegisterFunc(
                ...
                _m_SetCustomParticleData
            );
            Utils.RegisterFunc(
                L,
                Utils.METHOD_IDX,
                "GetCustomParticleData",
                _m_GetCustomParticleData
            );
            ...
            Utils.RegisterFunc(
                ...
                _m_AllocateAxisOfRotationAttribute
            );
            Utils.RegisterFunc(
                L,
                Utils.METHOD_IDX,
                "AllocateMeshIndexAttribute",
                _m_AllocateMeshIndexAttribute
            );
            Utils.RegisterFunc(
                L,
                Utils.METHOD_IDX,
                "AllocateCustomDataAttribute",
                _m_AllocateCustomDataAttribute
            );
            ...
            Utils.RegisterFunc(
                ...
                _g_get_proceduralSimulationSupported
            );
            ...
            Utils.RegisterFunc(
                ...
                _g_get_velocityOverLifetime
            );
            Utils.RegisterFunc(
                L,
                Utils.GETTER_IDX,
                "limitVelocityOverLifetime",
                _g_get_limitVelocityOverLifetime
            );
            ...
            Utils.RegisterFunc(
                ...
                _m_SetMaximumPreMappedBufferCounts_xlua_st_
            );
        ...
        static int __CreateInstance(RealStatePtr L)
        {
            ...
            return LuaAPI.luaL_error(
                L,
                "invalid arguments to UnityEngine.ParticleSystem constructor!"
            );
        }
        ...
        static int _m_SetParticles(RealStatePtr L)
        {
            try
            {
                ...
                UnityEngine.ParticleSystem gen_to_be_invoked = (UnityEngine.ParticleSystem)
                ...
                if (
                    gen_param_count == 2
                    && translator.Assignable<UnityEngine.ParticleSystem.Particle[]>(L, 2)
                )
                {
                ...
                if (
                    gen_param_count == 2
                    && translator.Assignable<Unity.Collections.NativeArray<UnityEngine.ParticleSystem.Particle>>(
                        L,
                        2
                    )
                )
                {
                    Unity.Collections.NativeArray<UnityEngine.ParticleSystem.Particle> _particles;
                    translator.Get(L, 2, out _particles);
            ...
            return LuaAPI.luaL_error(
                L,
                "invalid arguments to UnityEngine.ParticleSystem.SetParticles!"
            );
        }
        ...
        static int _m_GetParticles(RealStatePtr L)
        {
            ...
            return LuaAPI.luaL_error(
                L,
                "invalid arguments to UnityEngine.ParticleSystem.GetParticles!"
            );
        }
        ...
        static int _m_SetCustomParticleData(RealStatePtr L)
        {
            try
            {
                ...
                {
                    System.Collections.Generic.List<UnityEngine.Vector4> _customData =
                        (System.Collections.Generic.List<UnityEngine.Vector4>)
                            translator.GetObject(
                                L,
                                2,
                                typeof(System.Collections.Generic.List<UnityEngine.Vector4>)
                            );
                    UnityEngine.ParticleSystemCustomData _streamIndex;
                    translator.Get(L, 3, out _streamIndex);
        ...
        static int _m_GetCustomParticleData(RealStatePtr L)
        {
            try
            {
...

                {
                    ...
                    var gen_ret = gen_to_be_invoked.GetCustomParticleData(
                        _customData,
                        _streamIndex
                    );
                    LuaAPI.xlua_pushinteger(L, gen_ret);
        ...
        static int _m_SetPlaybackState(RealStatePtr L)
        {
            try
            {
                ...
                {
                    UnityEngine.ParticleSystem.PlaybackState _playbackState;
                    translator.Get(L, 2, out _playbackState);
        ...
        static int _m_GetTrails(RealStatePtr L)
        {
            try
            {
                ...
                if (
                    gen_param_count == 2
                    && translator.Assignable<UnityEngine.ParticleSystem.Trails>(L, 2)
                )
                {
                    UnityEngine.ParticleSystem.Trails _trailData;
                    translator.Get(L, 2, out _trailData);
            ...
            return LuaAPI.luaL_error(
                L,
                "invalid arguments to UnityEngine.ParticleSystem.GetTrails!"
            );
        }
        ...
        static int _m_Simulate(RealStatePtr L)
        {
            try
            {
                ...
                if (
                    ...
                    && LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2)
                    && LuaTypes.LUA_TBOOLEAN == LuaAPI.lua_type(L, 3)
                    && LuaTypes.LUA_TBOOLEAN == LuaAPI.lua_type(L, 4)
                )
                {
                    float _t = (float)LuaAPI.lua_tonumber(L, 2);
                    bool _withChildren = LuaAPI.lua_toboolean(L, 3);
            ...
            return LuaAPI.luaL_error(
                L,
                "invalid arguments to UnityEngine.ParticleSystem.Simulate!"
            );
        }
        ...
        static int _m_Stop(RealStatePtr L)
        {
            try
            {
                ...
                if (
                    gen_param_count == 3
                    && LuaTypes.LUA_TBOOLEAN == LuaAPI.lua_type(L, 2)
                    && translator.Assignable<UnityEngine.ParticleSystemStopBehavior>(L, 3)
                )
                {
                    bool _withChildren = LuaAPI.lua_toboolean(L, 2);
                    UnityEngine.ParticleSystemStopBehavior _stopBehavior;
                    translator.Get(L, 3, out _stopBehavior);
        ...
        static int _m_Emit(RealStatePtr L)
        {
            try
            {
                ...
                if (
                    gen_param_count == 3
                    && translator.Assignable<UnityEngine.ParticleSystem.EmitParams>(L, 2)
                    && LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)
                )
                {
                    UnityEngine.ParticleSystem.EmitParams _emitParams;
                    translator.Get(L, 2, out _emitParams);
        ...
        static int _m_TriggerSubEmitter(RealStatePtr L)
        {
            try
            {
                ...
                if (
                    gen_param_count == 3
                    && LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2)
                    && translator.Assignable<UnityEngine.ParticleSystem.Particle>(L, 3)
                )
                {
                    int _subEmitterIndex = LuaAPI.xlua_tointeger(L, 2);
                    UnityEngine.ParticleSystem.Particle _particle;
                    translator.Get(L, 3, out _particle);
                ...
                if (
                    gen_param_count == 3
                    && LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2)
                    && translator.Assignable<System.Collections.Generic.List<UnityEngine.ParticleSystem.Particle>>(
                        L,
                        3
                    )
                )
                {
                    int _subEmitterIndex = LuaAPI.xlua_tointeger(L, 2);
                    System.Collections.Generic.List<UnityEngine.ParticleSystem.Particle> _particles =
                        (System.Collections.Generic.List<UnityEngine.ParticleSystem.Particle>)
                            translator.GetObject(
                                L,
                                3,
                                typeof(System.Collections.Generic.List<UnityEngine.ParticleSystem.Particle>)
                            );
            ...
            return LuaAPI.luaL_error(
                L,
                "invalid arguments to UnityEngine.ParticleSystem.TriggerSubEmitter!"
            );
        }
        ...
        static int _m_AllocateCustomDataAttribute(RealStatePtr L)
        {
            try
            {
                ...
                {
                    UnityEngine.ParticleSystemCustomData _stream;
                    translator.Get(L, 2, out _stream);
