    ...
    public class UnityEngineVector3Wrap
    {
        public static void __Register(RealStatePtr L)
        {
            ...
            Utils.RegisterFunc(
                ...
                "positiveInfinity",
                _g_get_positiveInfinity
            );
            Utils.RegisterFunc(
                L,
                Utils.CLS_GETTER_IDX,
                "negativeInfinity",
                _g_get_negativeInfinity
            );
        ...
        static int __AddMeta(RealStatePtr L)
        {
            ...
            return LuaAPI.luaL_error(
                L,
                "invalid arguments to right hand of + operator, need UnityEngine.Vector3!"
            );
        }
        ...
        static int _m_Slerp_xlua_st_(RealStatePtr L)
        {
            try
            {
                ...
                {
                    UnityEngine.Vector3 _a;
                    translator.Get(L, 1, out _a);
                    UnityEngine.Vector3 _b;
        ...
        static int _m_RotateTowards_xlua_st_(RealStatePtr L)
        {
            try
            {
                ...
                {
                    UnityEngine.Vector3 _current;
                    translator.Get(L, 1, out _current);
                    UnityEngine.Vector3 _target;
                    ...
                    var gen_ret = UnityEngine.Vector3.RotateTowards(
                        _current,
                        _target,
                        _maxRadiansDelta,
                        _maxMagnitudeDelta
        ...
        static int _m_MoveTowards_xlua_st_(RealStatePtr L)
        {
            try
            {
...

                {
                    ...
                    var gen_ret = UnityEngine.Vector3.MoveTowards(
                        _current,
                        _target,
                        _maxDistanceDelta
                    );
        ...
        static int _m_Cross_xlua_st_(RealStatePtr L)
        {
            try
            {
                ...
                {
                    UnityEngine.Vector3 _lhs;
                    translator.Get(L, 1, out _lhs);
                    UnityEngine.Vector3 _rhs;
        ...
        static int _m_Reflect_xlua_st_(RealStatePtr L)
        {
            try
            {
                ...
                {
                    UnityEngine.Vector3 _inDirection;
                    translator.Get(L, 1, out _inDirection);
                    UnityEngine.Vector3 _inNormal;
        ...
        static int _m_ProjectOnPlane_xlua_st_(RealStatePtr L)
        {
            try
            {
...

                {
                    UnityEngine.Vector3 _vector;
                    translator.Get(L, 1, out _vector);
                    UnityEngine.Vector3 _planeNormal;
        ...
        static int _m_Angle_xlua_st_(RealStatePtr L)
        {
            try
            {
                ...
                {
                    UnityEngine.Vector3 _from;
                    translator.Get(L, 1, out _from);
                    UnityEngine.Vector3 _to;
