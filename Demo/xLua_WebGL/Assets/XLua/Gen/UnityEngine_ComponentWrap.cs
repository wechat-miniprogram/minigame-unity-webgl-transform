    ...
    public class UnityEngineComponentWrap
    {
        ...
        static int _m_GetComponent(RealStatePtr L)
        {
            try
            {
                ...
                UnityEngine.Component gen_to_be_invoked = (UnityEngine.Component)
        ...
        static int _m_GetComponentInChildren(RealStatePtr L)
        {
            ...
            return LuaAPI.luaL_error(
                L,
                "invalid arguments to UnityEngine.Component.GetComponentInChildren!"
            );
        }
        ...
        static int _m_GetComponentsInChildren(RealStatePtr L)
        {
            ...
            return LuaAPI.luaL_error(
                L,
                "invalid arguments to UnityEngine.Component.GetComponentsInChildren!"
            );
        }
        ...
        static int _m_GetComponentInParent(RealStatePtr L)
        {
            ...
            return LuaAPI.luaL_error(
                L,
                "invalid arguments to UnityEngine.Component.GetComponentInParent!"
            );
        }
        ...
        static int _m_GetComponentsInParent(RealStatePtr L)
        {
            ...
            return LuaAPI.luaL_error(
                L,
                "invalid arguments to UnityEngine.Component.GetComponentsInParent!"
            );
        }
        ...
        static int _m_GetComponents(RealStatePtr L)
        {
            ...
            return LuaAPI.luaL_error(
                L,
                "invalid arguments to UnityEngine.Component.GetComponents!"
            );
        }
        ...
        static int _m_SendMessageUpwards(RealStatePtr L)
        {
            ...
            return LuaAPI.luaL_error(
                L,
                "invalid arguments to UnityEngine.Component.SendMessageUpwards!"
            );
        }
        ...
        static int _m_BroadcastMessage(RealStatePtr L)
        {
            ...
            return LuaAPI.luaL_error(
                L,
                "invalid arguments to UnityEngine.Component.BroadcastMessage!"
            );
        }
