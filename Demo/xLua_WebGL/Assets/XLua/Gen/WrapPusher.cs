...
namespace XLua
{
    public partial class ObjectTranslator
    {
        class IniterAdderUnityEngineVector2
        {
            ...
            {
                translator.RegisterPushAndGetAndUpdate<UnityEngine.Vector2>(
                    translator.PushUnityEngineVector2,
                    translator.Get,
                    translator.UpdateUnityEngineVector2
                );
                translator.RegisterPushAndGetAndUpdate<UnityEngine.Vector3>(
                    translator.PushUnityEngineVector3,
                    translator.Get,
                    translator.UpdateUnityEngineVector3
                );
                translator.RegisterPushAndGetAndUpdate<UnityEngine.Vector4>(
                    translator.PushUnityEngineVector4,
                    translator.Get,
                    translator.UpdateUnityEngineVector4
                );
                translator.RegisterPushAndGetAndUpdate<UnityEngine.Color>(
                    translator.PushUnityEngineColor,
                    translator.Get,
                    translator.UpdateUnityEngineColor
                );
                translator.RegisterPushAndGetAndUpdate<UnityEngine.Quaternion>(
                    translator.PushUnityEngineQuaternion,
                    translator.Get,
                    translator.UpdateUnityEngineQuaternion
                );
                translator.RegisterPushAndGetAndUpdate<UnityEngine.Ray>(
                    translator.PushUnityEngineRay,
                    translator.Get,
                    translator.UpdateUnityEngineRay
                );
                translator.RegisterPushAndGetAndUpdate<UnityEngine.Bounds>(
                    translator.PushUnityEngineBounds,
                    translator.Get,
                    translator.UpdateUnityEngineBounds
                );
                translator.RegisterPushAndGetAndUpdate<UnityEngine.Ray2D>(
                    translator.PushUnityEngineRay2D,
                    translator.Get,
                    translator.UpdateUnityEngineRay2D
                );
                translator.RegisterPushAndGetAndUpdate<XLuaTest.Pedding>(
                    translator.PushXLuaTestPedding,
                    translator.Get,
                    translator.UpdateXLuaTestPedding
                );
                translator.RegisterPushAndGetAndUpdate<XLuaTest.MyStruct>(
                    translator.PushXLuaTestMyStruct,
                    translator.Get,
                    translator.UpdateXLuaTestMyStruct
                );
                translator.RegisterPushAndGetAndUpdate<XLuaTest.PushAsTableStruct>(
                    translator.PushXLuaTestPushAsTableStruct,
                    translator.Get,
                    translator.UpdateXLuaTestPushAsTableStruct
                );
                translator.RegisterPushAndGetAndUpdate<Tutorial.TestEnum>(
                    translator.PushTutorialTestEnum,
                    translator.Get,
                    translator.UpdateTutorialTestEnum
                );
                translator.RegisterPushAndGetAndUpdate<XLuaTest.MyEnum>(
                    translator.PushXLuaTestMyEnum,
                    translator.Get,
                    translator.UpdateXLuaTestMyEnum
                );
                translator.RegisterPushAndGetAndUpdate<Tutorial.DerivedClass.TestEnumInner>(
                    translator.PushTutorialDerivedClassTestEnumInner,
                    translator.Get,
                    translator.UpdateTutorialDerivedClassTestEnumInner
                );
            }
        }

        static IniterAdderUnityEngineVector2 s_IniterAdderUnityEngineVector2_dumb_obj =
            new IniterAdderUnityEngineVector2();
        static IniterAdderUnityEngineVector2 IniterAdderUnityEngineVector2_dumb_obj
        {
            get { return s_IniterAdderUnityEngineVector2_dumb_obj; }
        }
        ...
        public void Get(RealStatePtr L, int index, out UnityEngine.Vector2 val)
        {
            ...
            {
                val = (UnityEngine.Vector2)
                    objectCasters.GetCaster(typeof(UnityEngine.Vector2))(L, index, null);
            }
        }
        ...
        public void UpdateUnityEngineVector2(RealStatePtr L, int index, UnityEngine.Vector2 val)
        {
            ...
            {
                throw new Exception(
                    "try to update a data with lua type:" + LuaAPI.lua_type(L, index)
                );
            }
        }
        ...
        public void Get(RealStatePtr L, int index, out UnityEngine.Vector3 val)
        {
            ...
            else
            {
                val = (UnityEngine.Vector3)
                    objectCasters.GetCaster(typeof(UnityEngine.Vector3))(L, index, null);
            }
        }
        ...
        public void Get(RealStatePtr L, int index, out UnityEngine.Vector4 val)
        {
            ...
            else
            {
                val = (UnityEngine.Vector4)
                    objectCasters.GetCaster(typeof(UnityEngine.Vector4))(L, index, null);
            }
        }
        ...
        public void Get(RealStatePtr L, int index, out UnityEngine.Color val)
        {
            ...
            {
                val = (UnityEngine.Color)
                    objectCasters.GetCaster(typeof(UnityEngine.Color))(L, index, null);
            }
        }
        ...
        public void PushUnityEngineQuaternion(RealStatePtr L, UnityEngine.Quaternion val)
        {
            ...
            {
                bool is_first;
                UnityEngineQuaternion_TypeID = getTypeId(
                    L,
        ...
        public void Get(RealStatePtr L, int index, out UnityEngine.Quaternion val)
        {
            ...
            {
                val = (UnityEngine.Quaternion)
                    objectCasters.GetCaster(typeof(UnityEngine.Quaternion))(L, index, null);
            }
        }

        public void UpdateUnityEngineQuaternion(
            RealStatePtr L,
            int index,
        ...
        public void Get(RealStatePtr L, int index, out UnityEngine.Ray val)
        {
            ...
            {
                val = (UnityEngine.Ray)
                    objectCasters.GetCaster(typeof(UnityEngine.Ray))(L, index, null);
            }
        }
        ...
        public void Get(RealStatePtr L, int index, out UnityEngine.Bounds val)
        {
            ...
            {
                val = (UnityEngine.Bounds)
                    objectCasters.GetCaster(typeof(UnityEngine.Bounds))(L, index, null);
            }
        }
        ...
        public void Get(RealStatePtr L, int index, out UnityEngine.Ray2D val)
        {
            ...
            {
                val = (UnityEngine.Ray2D)
                    objectCasters.GetCaster(typeof(UnityEngine.Ray2D))(L, index, null);
            }
        }
        ...
        public void Get(RealStatePtr L, int index, out XLuaTest.Pedding val)
        {
            ...
            {
                val = (XLuaTest.Pedding)
                    objectCasters.GetCaster(typeof(XLuaTest.Pedding))(L, index, null);
            }
        }
        ...
        public void Get(RealStatePtr L, int index, out XLuaTest.MyStruct val)
        {
            ...
            {
                val = (XLuaTest.MyStruct)
                    objectCasters.GetCaster(typeof(XLuaTest.MyStruct))(L, index, null);
            }
        }
        ...
        public void PushXLuaTestPushAsTableStruct(RealStatePtr L, XLuaTest.PushAsTableStruct val)
        {
            ...
            {
                bool is_first;
                XLuaTestPushAsTableStruct_TypeID = getTypeId(
                    L,
                    typeof(XLuaTest.PushAsTableStruct),
                    out is_first
                );
            }
        ...
        public void Get(RealStatePtr L, int index, out XLuaTest.PushAsTableStruct val)
        {
            ...
            {
                val = (XLuaTest.PushAsTableStruct)
                    objectCasters.GetCaster(typeof(XLuaTest.PushAsTableStruct))(L, index, null);
            }
        }

        public void UpdateXLuaTestPushAsTableStruct(
            RealStatePtr L,
            int index,
            XLuaTest.PushAsTableStruct val
        )
        {
        ...
        public void Get(RealStatePtr L, int index, out Tutorial.TestEnum val)
        {
            ...
            {
                val = (Tutorial.TestEnum)
                    objectCasters.GetCaster(typeof(Tutorial.TestEnum))(L, index, null);
            }
        }
        ...
        public void Get(RealStatePtr L, int index, out XLuaTest.MyEnum val)
        {
            ...
            {
                val = (XLuaTest.MyEnum)
                    objectCasters.GetCaster(typeof(XLuaTest.MyEnum))(L, index, null);
            }
        }
        ...
        public void PushTutorialDerivedClassTestEnumInner(
            RealStatePtr L,
            Tutorial.DerivedClass.TestEnumInner val
        )
        {
            if (TutorialDerivedClassTestEnumInner_TypeID == -1)
            {
                bool is_first;
                TutorialDerivedClassTestEnumInner_TypeID = getTypeId(
                    L,
                    typeof(Tutorial.DerivedClass.TestEnumInner),
                    out is_first
                );
                ...
                if (TutorialDerivedClassTestEnumInner_EnumRef == -1)
                {
                    ...
                    TutorialDerivedClassTestEnumInner_EnumRef = LuaAPI.luaL_ref(
                        L,
            ...
            if (
                LuaAPI.xlua_tryget_cachedud(L, (int)val, TutorialDerivedClassTestEnumInner_EnumRef)
                == 1
            )
            {
                return;
            ...
            {
                throw new Exception(
                    "pack fail fail for Tutorial.DerivedClass.TestEnumInner ,value=" + val
                );
            }
        ...
        public void Get(RealStatePtr L, int index, out Tutorial.DerivedClass.TestEnumInner val)
        {
            ...
            {
                val = (Tutorial.DerivedClass.TestEnumInner)
                    objectCasters.GetCaster(typeof(Tutorial.DerivedClass.TestEnumInner))(
                        L,
                        index,
                        null
                    );
        ...
        public void UpdateTutorialDerivedClassTestEnumInner(
            RealStatePtr L,
            int index,
            Tutorial.DerivedClass.TestEnumInner val
        )
        {
            if (LuaAPI.lua_type(L, index) == LuaTypes.LUA_TUSERDATA)
            {
                ...
                {
                    throw new Exception(
                        "pack fail for Tutorial.DerivedClass.TestEnumInner ,value=" + val
                    );
                }
            }
            else
    ...
    {
        internal static bool __tryArrayGet(
            Type type,
            RealStatePtr L,
        ...
        )
        {
            ...
            {
                Tutorial.DerivedClass.TestEnumInner[] array =
                    obj as Tutorial.DerivedClass.TestEnumInner[];
        ...
        internal static bool __tryArraySet(
            Type type,
            RealStatePtr L,
            ObjectTranslator translator,
            object obj,
