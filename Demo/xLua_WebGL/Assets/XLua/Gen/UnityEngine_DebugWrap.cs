    ...
    public class UnityEngineDebugWrap
    {
        public static void __Register(RealStatePtr L)
        {
            ...
            Utils.RegisterFunc(
                ...
                _m_ClearDeveloperConsole_xlua_st_
            );
            ...
            Utils.RegisterFunc(
                ...
                Utils.CLS_IDX,
                "LogAssertionFormat",
                _m_LogAssertionFormat_xlua_st_
            );
            ...
            Utils.RegisterFunc(
                ...
                _g_get_developerConsoleVisible
            );
            ...
            Utils.RegisterFunc(
                ...
                "developerConsoleVisible",
                _s_set_developerConsoleVisible
            );
        ...
        static int _m_DrawLine_xlua_st_(RealStatePtr L)
        {
            try
            {
                ...
                if (
                    gen_param_count == 2
                    && translator.Assignable<UnityEngine.Vector3>(L, 1)
                    && translator.Assignable<UnityEngine.Vector3>(L, 2)
                )
                {
                    UnityEngine.Vector3 _start;
                    translator.Get(L, 1, out _start);
                    UnityEngine.Vector3 _end;
                ...
                if (
                    ...
                    && translator.Assignable<UnityEngine.Vector3>(L, 1)
                    && translator.Assignable<UnityEngine.Vector3>(L, 2)
                    && translator.Assignable<UnityEngine.Color>(L, 3)
                )
                {
                    UnityEngine.Vector3 _start;
                    translator.Get(L, 1, out _start);
        ...
        static int _m_Log_xlua_st_(RealStatePtr L)
        {
            try
            {
                ...
                if (
                    gen_param_count == 2
                    && translator.Assignable<object>(L, 1)
                    && translator.Assignable<UnityEngine.Object>(L, 2)
                )
                {
                    object _message = translator.GetObject(L, 1, typeof(object));
                    UnityEngine.Object _context = (UnityEngine.Object)
                        translator.GetObject(L, 2, typeof(UnityEngine.Object));
        ...
        static int _m_LogFormat_xlua_st_(RealStatePtr L)
        {
            try
            {
                ...
                if (
                    ...
                    && (
                        LuaTypes.LUA_TNONE == LuaAPI.lua_type(L, 2)
                        || translator.Assignable<object>(L, 2)
                    )
                )
                {
                ...
                if (
                    gen_param_count >= 2
                    && translator.Assignable<UnityEngine.Object>(L, 1)
                ...
                {
                    UnityEngine.Object _context = (UnityEngine.Object)
                        translator.GetObject(L, 1, typeof(UnityEngine.Object));
                ...
                if (
                    gen_param_count >= 4
                    && translator.Assignable<UnityEngine.LogType>(L, 1)
                    && translator.Assignable<UnityEngine.LogOption>(L, 2)
                    && translator.Assignable<UnityEngine.Object>(L, 3)
                    && (LuaAPI.lua_isnil(L, 4) || LuaAPI.lua_type(L, 4) == LuaTypes.LUA_TSTRING)
                    && (
                        LuaTypes.LUA_TNONE == LuaAPI.lua_type(L, 5)
                        || translator.Assignable<object>(L, 5)
                    )
                )
                {
                    UnityEngine.LogType _logType;
                    translator.Get(L, 1, out _logType);
                    UnityEngine.LogOption _logOptions;
                    translator.Get(L, 2, out _logOptions);
                    UnityEngine.Object _context = (UnityEngine.Object)
                        translator.GetObject(L, 3, typeof(UnityEngine.Object));
        ...
        static int _m_LogException_xlua_st_(RealStatePtr L)
        {
            try
            {
                ...
                {
                    System.Exception _exception = (System.Exception)
                        translator.GetObject(L, 1, typeof(System.Exception));
                ...
                if (
                    gen_param_count == 2
                    && translator.Assignable<System.Exception>(L, 1)
                    && translator.Assignable<UnityEngine.Object>(L, 2)
                )
                {
                    System.Exception _exception = (System.Exception)
        ...
        static int _m_Assert_xlua_st_(RealStatePtr L)
        {
            try
            {
                ...
                if (
                    gen_param_count == 2
                    && LuaTypes.LUA_TBOOLEAN == LuaAPI.lua_type(L, 1)
                    && translator.Assignable<UnityEngine.Object>(L, 2)
                )
                {
                    bool _condition = LuaAPI.lua_toboolean(L, 1);
        ...
        static int _m_AssertFormat_xlua_st_(RealStatePtr L)
        {
            try
            {
                ...
                if (
                    ...
                    && (
                        LuaTypes.LUA_TNONE == LuaAPI.lua_type(L, 4)
                        || translator.Assignable<object>(L, 4)
                    )
                )
                {
                    bool _condition = LuaAPI.lua_toboolean(L, 1);
        ...
        static int _m_LogAssertionFormat_xlua_st_(RealStatePtr L)
        {
            ...
            return LuaAPI.luaL_error(
                L,
                "invalid arguments to UnityEngine.Debug.LogAssertionFormat!"
            );
        }
