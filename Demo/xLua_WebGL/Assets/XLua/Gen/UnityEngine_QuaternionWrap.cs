    ...
    public class UnityEngineQuaternionWrap
    {
        ...
        public static int __CSIndexer(RealStatePtr L)
        {
            try
            {
                ...
                if (
                    translator.Assignable<UnityEngine.Quaternion>(L, 1)
                    && LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2)
                )
                {
                    UnityEngine.Quaternion gen_to_be_invoked;
        ...
        static int __MulMeta(RealStatePtr L)
        {
            try
            {
                ...
                if (
                    translator.Assignable<UnityEngine.Quaternion>(L, 1)
                    && translator.Assignable<UnityEngine.Quaternion>(L, 2)
                )
                {
                    UnityEngine.Quaternion leftside;
                    translator.Get(L, 1, out leftside);
                    UnityEngine.Quaternion rightside;
            ...
            return LuaAPI.luaL_error(
                L,
                "invalid arguments to right hand of * operator, need UnityEngine.Quaternion!"
            );
        }
        ...
        static int _m_FromToRotation_xlua_st_(RealStatePtr L)
        {
            try
            {
                ...
                {
                    UnityEngine.Vector3 _fromDirection;
                    translator.Get(L, 1, out _fromDirection);
                    UnityEngine.Vector3 _toDirection;
                    translator.Get(L, 2, out _toDirection);

                    var gen_ret = UnityEngine.Quaternion.FromToRotation(
                        _fromDirection,
                        _toDirection
                    );
                    translator.PushUnityEngineQuaternion(L, gen_ret);
        ...
        static int _m_Slerp_xlua_st_(RealStatePtr L)
        {
            try
            {
                ...
                {
                    UnityEngine.Quaternion _a;
                    translator.Get(L, 1, out _a);
                    UnityEngine.Quaternion _b;
        ...
        static int _m_LookRotation_xlua_st_(RealStatePtr L)
        {
            ...
            return LuaAPI.luaL_error(
                L,
                "invalid arguments to UnityEngine.Quaternion.LookRotation!"
            );
        }
        ...
        static int _m_SetLookRotation(RealStatePtr L)
        {
            ...
            return LuaAPI.luaL_error(
                L,
                "invalid arguments to UnityEngine.Quaternion.SetLookRotation!"
            );
        }
        ...
        static int _m_Equals(RealStatePtr L)
        {
            try
            {
                ...
                {
                    UnityEngine.Quaternion _other;
                    translator.Get(L, 2, out _other);
