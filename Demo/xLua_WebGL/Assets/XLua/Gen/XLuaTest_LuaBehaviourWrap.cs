    ...
    public class XLuaTestLuaBehaviourWrap
    {
        ...
        static int _g_get_luaScript(RealStatePtr L)
        {
            try
            {
                ...
                XLuaTest.LuaBehaviour gen_to_be_invoked = (XLuaTest.LuaBehaviour)
        ...
        static int _s_set_luaScript(RealStatePtr L)
        {
            try
            {
                ...
                XLuaTest.LuaBehaviour gen_to_be_invoked = (XLuaTest.LuaBehaviour)
                    translator.FastGetCSObj(L, 1);
                gen_to_be_invoked.luaScript = (UnityEngine.TextAsset)
                    translator.GetObject(L, 2, typeof(UnityEngine.TextAsset));
            }
            catch (System.Exception gen_e)
            {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
        ...
        static int _s_set_injections(RealStatePtr L)
        {
            try
            {
                ...
                XLuaTest.LuaBehaviour gen_to_be_invoked = (XLuaTest.LuaBehaviour)
                    translator.FastGetCSObj(L, 1);
                gen_to_be_invoked.injections = (XLuaTest.Injection[])
                    translator.GetObject(L, 2, typeof(XLuaTest.Injection[]));
            }
            catch (System.Exception gen_e)
            {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
