    ...
    public class UnityEngineSkinnedMeshRendererWrap
    {
        public static void __Register(RealStatePtr L)
        {
            ...
            Utils.RegisterFunc(
                ...
                Utils.GETTER_IDX,
                "updateWhenOffscreen",
                _g_get_updateWhenOffscreen
            );
            Utils.RegisterFunc(
                L,
                Utils.GETTER_IDX,
                "forceMatrixRecalculationPerRender",
                _g_get_forceMatrixRecalculationPerRender
            );
            ...
            Utils.RegisterFunc(
                ...
                _g_get_skinnedMotionVectors
            );
            Utils.RegisterFunc(
                L,
                Utils.GETTER_IDX,
                "vertexBufferTarget",
                _g_get_vertexBufferTarget
            );
            ...
            Utils.RegisterFunc(
                ...
                Utils.SETTER_IDX,
                "updateWhenOffscreen",
                _s_set_updateWhenOffscreen
            );
            Utils.RegisterFunc(
                L,
                Utils.SETTER_IDX,
                "forceMatrixRecalculationPerRender",
                _s_set_forceMatrixRecalculationPerRender
            );
            ...
            Utils.RegisterFunc(
                ...
                Utils.SETTER_IDX,
                "skinnedMotionVectors",
                _s_set_skinnedMotionVectors
            );
            Utils.RegisterFunc(
                L,
                Utils.SETTER_IDX,
                "vertexBufferTarget",
                _s_set_vertexBufferTarget
            );
        ...
        static int __CreateInstance(RealStatePtr L)
        {
            ...
            return LuaAPI.luaL_error(
                L,
                "invalid arguments to UnityEngine.SkinnedMeshRenderer constructor!"
            );
        }
        ...
        static int _m_GetBlendShapeWeight(RealStatePtr L)
        {
            try
            {
                ...
                UnityEngine.SkinnedMeshRenderer gen_to_be_invoked =
                    (UnityEngine.SkinnedMeshRenderer)translator.FastGetCSObj(L, 1);
        ...
        static int _m_BakeMesh(RealStatePtr L)
        {
            try
            {
                ...
                {
                    UnityEngine.Mesh _mesh = (UnityEngine.Mesh)
                        translator.GetObject(L, 2, typeof(UnityEngine.Mesh));
                ...
                if (
                    gen_param_count == 3
                    && translator.Assignable<UnityEngine.Mesh>(L, 2)
            ...
            return LuaAPI.luaL_error(
                L,
                "invalid arguments to UnityEngine.SkinnedMeshRenderer.BakeMesh!"
            );
        }
        ...
        static int _s_set_quality(RealStatePtr L)
        {
            try
            {
                ...
                UnityEngine.SkinnedMeshRenderer gen_to_be_invoked =
                    (UnityEngine.SkinnedMeshRenderer)translator.FastGetCSObj(L, 1);
                UnityEngine.SkinQuality gen_value;
        ...
        static int _s_set_rootBone(RealStatePtr L)
        {
            try
            {
                ...
                UnityEngine.SkinnedMeshRenderer gen_to_be_invoked =
                    (UnityEngine.SkinnedMeshRenderer)translator.FastGetCSObj(L, 1);
                gen_to_be_invoked.rootBone = (UnityEngine.Transform)
        ...
        static int _s_set_bones(RealStatePtr L)
        {
            try
            {
                ...
                UnityEngine.SkinnedMeshRenderer gen_to_be_invoked =
                    (UnityEngine.SkinnedMeshRenderer)translator.FastGetCSObj(L, 1);
                gen_to_be_invoked.bones = (UnityEngine.Transform[])
                    translator.GetObject(L, 2, typeof(UnityEngine.Transform[]));
            }
            catch (System.Exception gen_e)
            {
        ...
        static int _s_set_sharedMesh(RealStatePtr L)
        {
            try
            {
                ...
                UnityEngine.SkinnedMeshRenderer gen_to_be_invoked =
                    (UnityEngine.SkinnedMeshRenderer)translator.FastGetCSObj(L, 1);
                gen_to_be_invoked.sharedMesh = (UnityEngine.Mesh)
                    translator.GetObject(L, 2, typeof(UnityEngine.Mesh));
            }
            catch (System.Exception gen_e)
            {
        ...
        static int _s_set_vertexBufferTarget(RealStatePtr L)
        {
            try
            {
                ...
                UnityEngine.SkinnedMeshRenderer gen_to_be_invoked =
                    (UnityEngine.SkinnedMeshRenderer)translator.FastGetCSObj(L, 1);
                UnityEngine.GraphicsBuffer.Target gen_value;
                translator.Get(L, 2, out gen_value);
