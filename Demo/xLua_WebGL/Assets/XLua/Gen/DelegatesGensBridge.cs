    ...
    public partial class DelegateBridge : DelegateBridgeBase
    {
        ...
        public UnityEngine.Vector3 __Gen_Delegate_Imp5(UnityEngine.Vector3 p0)
        {
            ...
            lock (luaEnv.luaEnvLock)
            {
                ...
                UnityEngine.Vector3 __gen_ret;
                translator.Get(L, errFunc + 1, out __gen_ret);
                LuaAPI.lua_settop(L, errFunc - 1);
                return __gen_ret;
#if THREAD_SAFE || HOTFIX_ENABLE
            }
        ...
        public int __Gen_Delegate_Imp11(int p0, string p1, out Tutorial.CSCallLua.DClass p2)
        {
            ...
            lock (luaEnv.luaEnvLock)
            {
                ...
                p2 = (Tutorial.CSCallLua.DClass)
                    translator.GetObject(L, errFunc + 2, typeof(Tutorial.CSCallLua.DClass));
        ...
        public XLuaTest.InvokeLua.ICalc __Gen_Delegate_Imp13(int p0, string[] p1)
        {
            ...
            lock (luaEnv.luaEnvLock)
            {
                ...
                XLuaTest.InvokeLua.ICalc __gen_ret = (XLuaTest.InvokeLua.ICalc)
                    translator.GetObject(L, errFunc + 1, typeof(XLuaTest.InvokeLua.ICalc));
                LuaAPI.lua_settop(L, errFunc - 1);
                return __gen_ret;
#if THREAD_SAFE || HOTFIX_ENABLE
            }
        ...
        public UnityEngine.Vector3 __Gen_Delegate_Imp16(
            object p0,
        ...
        public UnityEngine.GameObject __Gen_Delegate_Imp21(
            XLuaTest.StructTest p0,
            int p1,
            object p2
        )
        {
            ...
            lock (luaEnv.luaEnvLock)
            {
                ...
                UnityEngine.GameObject __gen_ret = (UnityEngine.GameObject)
                    translator.GetObject(L, errFunc + 1, typeof(UnityEngine.GameObject));
                LuaAPI.lua_settop(L, errFunc - 1);
                return __gen_ret;
#if THREAD_SAFE || HOTFIX_ENABLE
            }
