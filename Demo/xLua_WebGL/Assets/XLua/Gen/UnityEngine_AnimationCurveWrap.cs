...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineAnimationCurveWrap
    {
        public static void __Register(RealStatePtr L)
        {
            ...
            Utils.EndObjectRegister(type, L, translator, __CSIndexer, null, null, null, null);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
            try
            {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
                if (
                    LuaAPI.lua_gettop(L) >= 1
                    && (
                        LuaTypes.LUA_TNONE == LuaAPI.lua_type(L, 2)
                        || translator.Assignable<UnityEngine.Keyframe>(L, 2)
                    )
                )
                {
            ...
            return LuaAPI.luaL_error(
                L,
                "invalid arguments to UnityEngine.AnimationCurve constructor!"
            );
        }
        ...
        public static int __CSIndexer(RealStatePtr L)
        {
            try
            {
                ...
                if (
                    translator.Assignable<UnityEngine.AnimationCurve>(L, 1)
                    && LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2)
                )
                {
                    UnityEngine.AnimationCurve gen_to_be_invoked = (UnityEngine.AnimationCurve)
        ...
        static int _m_AddKey(RealStatePtr L)
        {
            try
            {
                ...
                {
                    UnityEngine.Keyframe _key;
                    translator.Get(L, 2, out _key);
        ...
        static int _m_Linear_xlua_st_(RealStatePtr L)
        {
            try
            {
...

                {
                    ...
                    var gen_ret = UnityEngine.AnimationCurve.Linear(
                        _timeStart,
                        _valueStart,
                        _timeEnd,
                        _valueEnd
        ...
        static int _m_EaseInOut_xlua_st_(RealStatePtr L)
        {
            try
            {
...

                {
                    ...
                    var gen_ret = UnityEngine.AnimationCurve.EaseInOut(
                        _timeStart,
                        _valueStart,
                        _timeEnd,
                        _valueEnd
        ...
        static int _m_Equals(RealStatePtr L)
        {
            try
            {
                ...
                {
                    UnityEngine.AnimationCurve _other = (UnityEngine.AnimationCurve)
        ...
        static int _s_set_keys(RealStatePtr L)
        {
            try
            {
                ...
                UnityEngine.AnimationCurve gen_to_be_invoked = (UnityEngine.AnimationCurve)
                    translator.FastGetCSObj(L, 1);
                gen_to_be_invoked.keys = (UnityEngine.Keyframe[])
                    translator.GetObject(L, 2, typeof(UnityEngine.Keyframe[]));
            }
            catch (System.Exception gen_e)
            {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
        ...
        static int _s_set_preWrapMode(RealStatePtr L)
        {
            try
            {
                ...
                UnityEngine.AnimationCurve gen_to_be_invoked = (UnityEngine.AnimationCurve)
                    translator.FastGetCSObj(L, 1);
                UnityEngine.WrapMode gen_value;
