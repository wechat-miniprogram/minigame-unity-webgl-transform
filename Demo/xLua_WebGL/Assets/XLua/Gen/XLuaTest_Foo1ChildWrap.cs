    ...
    public class XLuaTestFoo1ChildWrap
    {
        ...
        static int __CreateInstance(RealStatePtr L)
        {
            try
            {
                ...
                {
                    var gen_ret = new XLuaTest.Foo1Child();
        ...
        static int _m_Extension1(RealStatePtr L)
        {
            try
            {
                ...
                XLuaTest.Foo1Child gen_to_be_invoked = (XLuaTest.Foo1Child)
        ...
        static int _m_Extension2(RealStatePtr L)
        {
            try
            {
                ...
                {
                    UnityEngine.GameObject _b = (UnityEngine.GameObject)
                ...
                if (gen_param_count == 2 && translator.Assignable<XLuaTest.Foo2Parent>(L, 2))
                {
                    XLuaTest.Foo2Parent _b = (XLuaTest.Foo2Parent)
                        translator.GetObject(L, 2, typeof(XLuaTest.Foo2Parent));
