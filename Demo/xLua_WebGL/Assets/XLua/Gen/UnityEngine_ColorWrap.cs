    ...
    public class UnityEngineColorWrap
    {
        ...
        public static int __CSIndexer(RealStatePtr L)
        {
            try
            {
                ...
                if (
                    translator.Assignable<UnityEngine.Color>(L, 1)
                    && LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2)
                )
                {
                    UnityEngine.Color gen_to_be_invoked;
        ...
        static int __AddMeta(RealStatePtr L)
        {
            try
            {
                ...
                if (
                    translator.Assignable<UnityEngine.Color>(L, 1)
                    && translator.Assignable<UnityEngine.Color>(L, 2)
                )
                {
                    UnityEngine.Color leftside;
                    translator.Get(L, 1, out leftside);
                    UnityEngine.Color rightside;
            ...
            return LuaAPI.luaL_error(
                L,
                "invalid arguments to right hand of + operator, need UnityEngine.Color!"
            );
        }
        ...
        static int _m_Lerp_xlua_st_(RealStatePtr L)
        {
            try
            {
                ...
                {
                    UnityEngine.Color _a;
                    translator.Get(L, 1, out _a);
                    UnityEngine.Color _b;
