    ...
    public class XLuaTestNoGcWrap
    {
        ...
        static int _m_Vector3ParamMethod(RealStatePtr L)
        {
            try
            {
                ...
                {
                    UnityEngine.Vector3 _p;
                    translator.Get(L, 2, out _p);
        ...
        static int _s_set_a2(RealStatePtr L)
        {
            try
            {
                ...
                XLuaTest.NoGc gen_to_be_invoked = (XLuaTest.NoGc)translator.FastGetCSObj(L, 1);
                gen_to_be_invoked.a2 = (UnityEngine.Vector3[])
                    translator.GetObject(L, 2, typeof(UnityEngine.Vector3[]));
            }
            catch (System.Exception gen_e)
            {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
        ...
        static int _s_set_a3(RealStatePtr L)
        {
            try
            {
                ...
                XLuaTest.NoGc gen_to_be_invoked = (XLuaTest.NoGc)translator.FastGetCSObj(L, 1);
                gen_to_be_invoked.a3 = (XLuaTest.MyStruct[])
                    translator.GetObject(L, 2, typeof(XLuaTest.MyStruct[]));
            }
            catch (System.Exception gen_e)
            {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
        ...
        static int _s_set_a4(RealStatePtr L)
        {
            try
            {
                ...
                XLuaTest.NoGc gen_to_be_invoked = (XLuaTest.NoGc)translator.FastGetCSObj(L, 1);
                gen_to_be_invoked.a4 = (XLuaTest.MyEnum[])
                    translator.GetObject(L, 2, typeof(XLuaTest.MyEnum[]));
            }
            catch (System.Exception gen_e)
            {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
