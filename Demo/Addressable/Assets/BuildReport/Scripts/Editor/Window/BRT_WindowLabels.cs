...
namespace BuildReportTool.Window
{
    public static class Labels
    {
        ...
        public const string UNUSED_TOTAL_SIZE_DESC =
            "Total size of project assets not included in the build.";
        ...
        public const string STREAMING_ASSETS_SIZE_DESC =
            "Total size of all files in the StreamingAssets folder.";

        public const string BUILD_SIZE_STANDALONE_DESC =
            "File size of the executable file and the accompanying Data folder.";

        public const string BUILD_SIZE_WINDOWS_DESC =
            "File size of the .exe file and the accompanying Data folder.";
        ...
        public const string BUILD_SIZE_ANDROID_WITH_OBB_DESC =
            "File size of resulting .apk and .obb files.";
        public const string BUILD_SIZE_ANDROID_WITH_PROJECT_DESC =
            "File size of generated Eclipse project folder.";
        ...
        public const string SHOW_AFTER_BUILD_LABEL =
            "Show Build Report Window automatically after building";
        public const string INCLUDE_SVN_LABEL =
            "Include SVN metadata when creating Unused Assets list";
        public const string INCLUDE_GIT_LABEL =
            "Include Git metadata when creating Unused Assets list";
        ...
        public const string DEFAULT_EDITOR_LOG_NOT_FOUND_MSG =
            "Warning: Unity Editor Log file not found.";
        ...
        public const string FILTER_GROUP_TO_USE_CONFIGURED_LABEL =
            "Always use configured file filter group";
        ...
        public const string CALCULATION_LEVEL_NO_PREFAB_NAME =
            "3 - Do not calculate unused prefabs";
        ...
        public const string CALCULATION_LEVEL_MINIMAL_NAME =
            "1 - Overview only (minimum calculations)";
