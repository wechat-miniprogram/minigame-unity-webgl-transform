...
namespace BuildReportTool.Window.Screen
{
    public partial class AssetList
    {
        ...
        /// "which is used by"
        /// </summary>
        static readonly GUIContent AssetUsageWhichIsUsedByLabel = new GUIContent(
            "which is used by"
        );
        ...
        /// </summary>
        static readonly GUIContent AssetUsageIsUsedAsDefaultMaterialByLabel = new GUIContent(
            "is used as default material by"
        );
        ...
        /// </summary>
        static readonly GUIContent AssetUsageWhichIsUsedAsDefaultMaterialByLabel = new GUIContent(
            "which is used as default material by"
        );
        ...
        /// </summary>
        static readonly GUIContent AssetUsageIsUsedAsDefaultValueByLabel = new GUIContent(
            "is used as default value by"
        );
        ...
        /// </summary>
        static readonly GUIContent AssetUsageWhichIsUsedAsDefaultValueByLabel = new GUIContent(
            "which is used as default value by"
        );
        ...
        /// </summary>
        static readonly GUIContent AssetUsageIsAResourcesAssetButAlsoUsedByLabel = new GUIContent(
            "is a Resources asset, so it's always in the build. But it's also used by"
        );
        ...
        /// </summary>
        static readonly GUIContent AssetUsageWhichIsInTheBuildLabel = new GUIContent(
            "which is in the build"
        );
        ...
        /// </summary>
        static readonly GUIContent AssetUsageIsAResourcesAssetLabel = new GUIContent(
            "is a Resources asset, so it's always in the build"
        );
        ...
        /// </summary>
        static readonly GUIContent AssetUsageWhichIsAResourcesAssetLabel = new GUIContent(
            "which is a Resources asset, so it's always in the build"
        );
        ...
        /// "(cyclic dependency)"
        /// </summary>
        static readonly GUIContent AssetUsageWhichIsACyclicDependencyLabel = new GUIContent(
            "(cyclic dependency)"
        );
        ...
        readonly Dictionary<string, PrettyAssetLabel> _prettyAssetLabels =
            new Dictionary<string, PrettyAssetLabel>();
        ...
        string GetPrettyAssetPath(string assetPath, bool showAssetPath, bool selected)
        {
            ...
            else
            {
                ...
                entry.AssetPathSelected = string.Format(
                    "<color=#{0}>{1}{2}</color><color=white><b>{3}</b></color>",
                ...
                entry.AssetPath = string.Format(
                    "<color=#{0}>{1}{2}</color><b>{3}</b>",
        ...
        static readonly string[] AssetUsageDisplayLabel = new[] { "All", "Direct", "End" };
        ...
        static bool IsFileNextToFile(
            List<AssetUsageAncestry> list,
            int idx,
            string fileTypeInIdx,
            string fileTypeInNext
        )
        {
            return !string.IsNullOrEmpty(list[idx].AssetPath)
                && list[idx].AssetPath.IsFileOfType(fileTypeInIdx)
                && (idx < list.Count - 1)
                && !string.IsNullOrEmpty(list[idx + 1].AssetPath)
                && list[idx + 1].AssetPath.IsFileOfType(fileTypeInNext);
        }
        ...
        )
        {
            ...
            _debugText.AppendFormat(
                "listToDisplay.GetSelectedCount(): {0}\n",
            ...
            if (dependencies.TryGetValue(selectedAsset.Name, out selectedAssetDependencies))
            {
                ...
                var selectedAssetUsers =
                    selectedAssetDependencies != null ? selectedAssetDependencies.Users : null;

#if BRT_ASSET_LIST_SCREEN_DEBUG
                _debugText.AppendFormat(
                    "selectedAssetDependencies.Users.Count: {0}\n",
...
#if BRT_ASSET_LIST_SCREEN_DEBUG
            _debugText.AppendFormat(
                "selectedHasNoAssetDependencies: {0}\n_selectedIsAResourcesAsset: {1}\n",
                selectedHasNoAssetDependencies.ToString(),
                _selectedIsAResourcesAsset.ToString()
            );
#endif
            ...
            if (selectedHasNoAssetDependencies)
            {
                ...
                if (_selectedIsAResourcesAsset)
                {
                    ...
                    _assetUsageRect = new Rect(0, position.height - height, position.width, height);
                    ...
                    )
                    {
                        ...
                        if (assetUsageAncestryEntryRect.Contains(Event.current.mousePosition))
                        {
                            ...
                            BRT_BuildReportWindow.UpdateHoveredAsset(
                                _selectedResourcesAssetPath,
                            ...
                            if (
                                ...
                                && BRT_BuildReportWindow.GetAssetPreview(
                                    _selectedResourcesAssetPath
                                ) != null
                            )
                            {
            ...
            switch (_selectedAssetUsageDisplayIdx)
            {
                case ASSET_USAGE_DISPLAY_ALL:
                {
                    ...
                    {
                        numberOfRowsInAssetUsageAncestry = GetNumberOfAssetUsageAncestryRows(
                            _assetUsageAncestry,
                            availableWidth
                        );
...
#if BRT_ASSET_LIST_SCREEN_DEBUG
                        _debugText.AppendFormat(
                            "numberOfRowsInAssetUsageTraceHistory: {0}\n",
                    ...
                    assetInfoPanelHeight +=
                        (ASSET_INFO_ROW_HEIGHT * numberOfRowsInAssetUsageAncestry)
                        + assetInfoPanelStyle.padding.vertical;
                    ...
                    if (numberOfRowsInAssetUsageAncestry > 1)
                    {
                        ...
                        assetInfoPanelHeight +=
                            ASSET_USAGE_HISTORY_ROW_SPACING
                            * (numberOfRowsInAssetUsageAncestry - 1);
                    ...
                    {
                        assetInfoPanelHeight +=
                            GUI.skin.label.CalcHeight(
                                AssetUsageAncestryDefaultMaterialInFbxOfScene,
                                position.width
...
#if BRT_ASSET_LIST_SCREEN_DEBUG
            _debugText.AppendFormat(
                "_selectedAssetUsageDisplayIdx: {0}\nassetInfoToolbarHeight: {1}\n",
            ...
            if (_showAssetUsagesList)
            {
                switch (_selectedAssetUsageDisplayIdx)
                {
                    ...
                    case ASSET_USAGE_DISPLAY_DIRECT:
...

                            {
                                ...
                                if (
                                    dependencies.TryGetValue(
                                        activeAssetUserCrumb,
                                        out activeAssetUserCrumbDependencyEntry
                                    )
                                )
                                {
                        ...
                        var initialListViewHeight =
                            (
                                ...
                                * selectedAssetDependencies.Users.Count
                    ...
                    case ASSET_USAGE_DISPLAY_END:
                    {
                        ...
                        {
                            BuildReportTool.AssetDependencies.PopulateAssetEndUsers(
                                selectedAsset.Name,
                                assetDependencies
                            );
                        }
                ...
                if (properHeight > position.height / 2)
                {
                    ...
                    assetUsageScrollViewHeight = Mathf.RoundToInt(
                        heightToUse - assetInfoPanelHeight
                    );
            ...
            _assetUsageRect = new Rect(
                0,
                position.height - heightToUse,
                position.width,
                heightToUse
            );
            ...
            if (_showAssetUsagesList)
            {
                ...
                _assetUsagePanelScrollbarPos = GUI.BeginScrollView(
                    new Rect(
                        0,
                        _assetInfoPanelRect.height,
                        position.width,
                        assetUsageScrollViewHeight
                    ),
                    _assetUsagePanelScrollbarPos,
                    scrollViewRect
                );
                ...
                switch (_selectedAssetUsageDisplayIdx)
                {
                    ...
                    case ASSET_USAGE_DISPLAY_DIRECT:
                        ...
                        {
                            assetToShowDirectUsersOf = _assetUserCrumbs[
                                _assetUserCrumbActiveIdx
                            ].AssetPath;
                        }
        ...
        void ChangeAssetUserCrumbRootIfNeeded(string assetPath)
        {
            if (
                _assetUserCrumbs.Count == 0
                || !_assetUserCrumbs[0]
                    .AssetPath.Equals(assetPath, StringComparison.OrdinalIgnoreCase)
            )
            {
        ...
        )
        {
            ...
            if (assetUsageListScrollViewHeightIsClamped && directUsers.Count > 0)
            {
                ...
                var toSkip = Mathf.FloorToInt(
                    _assetUsagePanelScrollbarPos.y / BRT_BuildReportWindow.LIST_HEIGHT
                );

                var amountToDraw =
                    (assetUsageScrollViewHeight / BRT_BuildReportWindow.LIST_HEIGHT) + 2;
            ...
            var listEntryStyle = GUI.skin.GetStyle(
                BuildReportTool.Window.Settings.LIST_SMALL_STYLE_NAME
            );
            var listAltEntryStyle = GUI.skin.GetStyle(
                BuildReportTool.Window.Settings.LIST_SMALL_ALT_STYLE_NAME
            );
            var listSelectedEntryStyle = GUI.skin.GetStyle(
                BuildReportTool.Window.Settings.LIST_SMALL_SELECTED_NAME
            );
            ...
            for (; directUserN < directUserLen; ++directUserN)
            {
                ...
                var labelRect = new Rect(0, currentY, 0, BRT_BuildReportWindow.LIST_HEIGHT);
                ...
                if (!BuildReportTool.Options.DoubleClickOnAssetWillPing)
                {
                    if (
                        GUI.Button(
                            new Rect(0, currentY + 1, PING_BUTTON_WIDTH, PING_BUTTON_HEIGHT),
                            "Ping",
                            "ListButton"
                        )
                    )
                ...
                {
                    var inspectButtonRect = new Rect(
                        currentX,
                        currentY + 1,
                        INSPECT_BUTTON_WIDTH,
                        INSPECT_BUTTON_HEIGHT
                    );
                    if (GUI.Button(inspectButtonRect, "Inspect", "ListButton"))
                    {
                        ...
                        if (!alreadyInBreadcrumbHistory)
                        {
                            if (_assetUserCrumbActiveIdx != _assetUserCrumbs.Count - 1)
                            {
                                ...
                                _assetUserCrumbs.RemoveRange(
                                    removalStartIdx,
                                    _assetUserCrumbs.Count - removalStartIdx
                                );
                            }
                ...
                _assetUsageEntryLabel.text = GetPrettyAssetPath(
                    assetPath,
                    _showAssetPath,
                ...
                if (labelPressed)
                {
                    ...
                    if (
                        ...
                        && _selectedAssetUserIdx == directUserN
                        && (EditorApplication.timeSinceStartup - _assetListEntryLastClickedTime)
        ...
        )
        {
            ...
            for (; userFlattenedN < userFlattenedLen; ++userFlattenedN)
            {
                ...
                if (usersFlattened[userFlattenedN].IndentLevel > 1)
                {
                    ...
                    int idxOfPrevious;
                    if (
                        BuildReportTool.AssetDependencyGenerator.IsFileTypeBeforeAnother(
                            usersFlattened,
                            userFlattenedN,
                            ".mat",
                            ".fbx",
                    ...
                    {
                        prefixLabelRect.width = styleToUse
                            .CalcSize(AssetUsageWhichIsUsedAsDefaultMaterialByLabel)
                            .x;
                        labelPressed |= GUI.Button(
                            prefixLabelRect,
                    ...
                    {
                        prefixLabelRect.width = styleToUse
                            .CalcSize(AssetUsageWhichIsUsedAsDefaultValueByLabel)
                            .x;
                        labelPressed |= GUI.Button(
                            prefixLabelRect,
                            AssetUsageWhichIsUsedAsDefaultValueByLabel,
                            styleToUse
                        );
                    }
                    else
                ...
                _assetUsageEntryLabel.text = GetPrettyAssetPath(
                    usersFlattened[userFlattenedN].AssetPath,
                    _showAssetPath,
                ...
                if (usersFlattened[userFlattenedN].CyclicDependency)
                {
                    ...
                    labelPressed |= GUI.Button(
                        suffixLabelRect,
                        AssetUsageWhichIsACyclicDependencyLabel,
                        styleToUse
                    );
                }
                ...
                for (
                    int indentN = 1, indentLen = usersFlattened[userFlattenedN].IndentLevel;
                    indentN < indentLen;
                    ++indentN
                )
                {
                    var indentRect = new Rect(
                        pingButtonUsedWidth + ((indentN - 1) * 20),
                        currentY,
                        20,
                        20
                    );
                ...
                if (labelPressed)
                {
                    ...
                    _assetUsageAncestryHasFbxUsingDefaultMaterialUsedInScene =
                        DoesAssetUsageAncestryHaveFbxUsingDefaultMaterialUsedInScene(
                            _assetUsageAncestry
                        );
        ...
        )
        {
            ...
            else if (_selectedAssetUsageDisplayIdx == ASSET_USAGE_DISPLAY_DIRECT)
            {
                ...
                _assetUsageEntryLabel.text = BuildReportTool.Util.GetAssetFilename(
                    _assetUserCrumbs[0].AssetPath
                );
                _assetUsageEntryLabel.image = AssetDatabase.GetCachedIcon(
                    _assetUserCrumbs[0].AssetPath
                );
                if (
                    GUILayout.Toggle(
                        _assetUserCrumbActiveIdx == 0,
                        _assetUsageEntryLabel,
                ...
                {
                    _assetUsageEntryLabel.text = BuildReportTool.Util.GetAssetFilename(
                        _assetUserCrumbs[crumbN].AssetPath
                    );
                    _assetUsageEntryLabel.image = AssetDatabase.GetCachedIcon(
                        _assetUserCrumbs[crumbN].AssetPath
                    );
        ...
        void DrawAssetInfoToolbar(
            Rect position,
            string selectedAssetPath,
            AssetDependencies assetDependencies
        )
        {
            var bgRect = new Rect(0, 0, position.width, ASSET_INFO_TOOLBAR_HEIGHT);
            ...
            var expandButtonRect = new Rect(
                bgRect.x + ((bgRect.width - EXPAND_BUTTON_WIDTH) / 2),
                bgRect.y,
                EXPAND_BUTTON_WIDTH,
                ASSET_INFO_TOOLBAR_HEIGHT
            );

            var showAllUsagesLabel = _showAssetUsagesList ? "Hide" : "Show More Usages";

            var newShowAssetUsersList = GUI.Toggle(
                expandButtonRect,
                _showAssetUsagesList,
                showAllUsagesLabel,
                "ExpandButton"
            );
            ...
            if (_showAssetUsagesList)
            {
                ...
                var assetUsageLabelRect = new Rect(
                    bgRect.x + 5,
                    bgRect.y,
                ...
                var newAssetUsageDisplayIdx = GUI.SelectionGrid(
                    new Rect(assetUsageLabelRect.xMax, bgRect.y, 150, ASSET_INFO_TOOLBAR_HEIGHT),
                ...
                if (newAssetUsageDisplayIdx != _selectedAssetUsageDisplayIdx)
                {
                    ...
                    if (_selectedAssetUsageDisplayIdx == ASSET_USAGE_DISPLAY_DIRECT)
                    {
                        ...
                        {
                            _assetUsagePanelScrollbarPos.y = _assetUserCrumbs[
                                _assetUserCrumbActiveIdx
                            ].ScrollbarPosY;
        ...
        )
        {
            ...
            for (int n = 0, len = _assetUsageAncestry.Count; n < len; ++n)
            {
                ...
                var assetPressed = GUILayout.Button(
                    _assetUsageAncestry[n].Label,
                ...
                )
                {
                    ...
                    if (assetUsageAncestryEntryRect.Contains(Event.current.mousePosition))
                    {
                        ...
                        // when the tooltip will be drawn
                        BRT_BuildReportWindow.UpdateHoveredAsset(
                            _assetUsageAncestry[n].AssetPath,
                            assetUsageAncestryEntryRect,
                            IsShowingUsedAssets,
                            buildReportToDisplay,
                            assetDependencies
                ...
                var isAssetUsedByScript =
                    (n < len - 1) && _assetUsageAncestry[n + 1].AssetPath.IsFileOfType(".cs");
                ...
                if (BuildReportTool.Options.IsAssetUsageLabelTypeOnVerbose)
                {
                    if (n == 0)
                    {
                        if (isMaterialUsedByMesh)
                        {
                            widthToAdd = assetLabelInBetweenStyle
                                .CalcSize(AssetUsageIsUsedAsDefaultMaterialByLabel)
                                .x;
                        }
                        else if (isAResourcesAsset)
                        {
                            widthToAdd = assetLabelInBetweenStyle
                                .CalcSize(AssetUsageIsAResourcesAssetButAlsoUsedByLabel)
                                .x;
                        }
                        else if (isAssetUsedByScript)
                        {
                            widthToAdd = assetLabelInBetweenStyle
                                .CalcSize(AssetUsageIsUsedAsDefaultValueByLabel)
                                .x;
                        }
                        else
                        {
                            widthToAdd = assetLabelInBetweenStyle
                                .CalcSize(AssetUsageIsUsedByLabel)
                                .x;
                        }
                    ...
                    else if (n < len - 1)
                    {
                        ...
                        {
                            widthToAdd = assetLabelInBetweenStyle
                                .CalcSize(AssetUsageWhichIsAResourcesAssetButAlsoUsedByLabel)
                                .x;
                        }
                        else if (isAssetUsedByScript)
                        {
                        ...
                        {
                            widthToAdd = assetLabelInBetweenStyle
                                .CalcSize(AssetUsageWhichIsUsedByLabel)
                                .x;
                        }
                    ...
                    else if (n == len - 1)
                    {
                        if (_assetUsageAncestry[n].AssetPath.IsSceneFile())
                        {
                            widthToAdd =
                                assetLabelInBetweenStyle
                                    .CalcSize(AssetUsageWhichIsInTheBuildLabel)
                                    .x + assetLabelInBetweenStyle.margin.horizontal;
                        }
                        else if (_assetUsageAncestry[n].AssetPath.IsInResourcesFolder())
                        {
                            widthToAdd =
                                assetLabelInBetweenStyle
                                    .CalcSize(AssetUsageWhichIsAResourcesAssetLabel)
                                    .x + assetLabelInBetweenStyle.margin.horizontal;
                        }
                        else if (_assetUsageAncestry[n].CyclicDependency)
                        {
                            widthToAdd =
                                assetLabelInBetweenStyle
                                    .CalcSize(AssetUsageWhichIsACyclicDependencyLabel)
                                    .x + assetLabelInBetweenStyle.margin.horizontal;
                        }
                    }
                }
                else if (BuildReportTool.Options.IsAssetUsageLabelTypeOnStandard)
                {
                    if (n < len - 1)
                    {
                        ...
                        widthToAdd =
                            assetUsageArrow.width + assetUsageArrowStyle.padding.horizontal;
                    }
                }
...
#if BRT_ASSET_LIST_SCREEN_DEBUG
                _debugText.AppendFormat(
                    "Actual Item {0} in-between width: {1}\n",
                    n.ToString(),
                    widthToAdd.ToString(CultureInfo.InvariantCulture)
                );
#endif
                ...
                if (BuildReportTool.Options.IsAssetUsageLabelTypeOnVerbose)
                {
                    if (n == 0)
                    {
                        ...
                        {
                            GUILayout.Label(
                                AssetUsageIsUsedAsDefaultMaterialByLabel,
                                assetLabelInBetweenStyle,
                                BRT_BuildReportWindow.LayoutNone
                            );
                        }
                        ...
                        {
                            GUILayout.Label(
                                AssetUsageIsUsedAsDefaultValueByLabel,
                                assetLabelInBetweenStyle,
                                BRT_BuildReportWindow.LayoutNone
                            );
                        }
                    ...
                    else if (n < len - 1)
                    {
                        ...
                        {
                            GUILayout.Label(
                                AssetUsageWhichIsAResourcesAssetButAlsoUsedByLabel,
                                assetLabelInBetweenStyle,
                                BRT_BuildReportWindow.LayoutNone
                            );
                        }
                    ...
                    else if (n == len - 1)
                    {
                        ...
                        {
                            GUILayout.Label(
                                AssetUsageWhichIsInTheBuildLabel,
                                assetLabelInBetweenStyle,
                                BRT_BuildReportWindow.LayoutNone
                            );
                        }
                ...
                else if (BuildReportTool.Options.IsAssetUsageLabelTypeOnStandard)
                {
                    ...
                    if (n < len - 1)
                    {
                        ...
                        Rect arrowRect = GUILayoutUtility.GetRect(
                            needWidth,
                        ...
                        {
                            arrowRect.y += (
                                (ASSET_INFO_ROW_HEIGHT - assetUsageArrow.height) / 2.0f
                            );
...
#if BRT_ASSET_LIST_SCREEN_DEBUG
                _debugText.AppendFormat(
                    "Item {0} in-between label width: {1}\n",
                    n,
                    widthToAdd.ToString(CultureInfo.InvariantCulture)
                );
#endif
        ...
        void SetAssetUsageHistoryToFirstEndUser(
            string rootAsset,
            AssetDependencies assetDependencies
        )
        {
        ...
        /// <returns></returns>
        static bool DoesAssetUsageAncestryHaveFbxUsingDefaultMaterialUsedInScene(
            List<AssetUsageAncestry> list
        )
        {
            if (
        ...
        /// <param name="rootAsset">the asset whose usage we are inspecting</param>
        static void SetAssetUsageAncestry(
        ...
        )
        {
            ...
            lastEntry.Label = new GUIContent(
            ...
            firstEntry.Label = new GUIContent(
