...
#pragma warning disable 0219
    public static class GameManager_Wrap
    {
        ...
        internal static void G_BallSpawnPoint(
            IntPtr isolate,
            IntPtr info,
            IntPtr self,
            int paramLen,
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        internal static void S_BallSpawnPoint(
            IntPtr isolate,
            IntPtr info,
            IntPtr self,
            int paramLen,
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        internal static void G_BallPrefab(
            IntPtr isolate,
            IntPtr info,
            IntPtr self,
            int paramLen,
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        internal static void S_BallPrefab(
            IntPtr isolate,
            IntPtr info,
            IntPtr self,
            int paramLen,
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        internal static void G_PrescoreTrigger(
            IntPtr isolate,
            IntPtr info,
            IntPtr self,
            int paramLen,
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        internal static void S_PrescoreTrigger(
            IntPtr isolate,
            IntPtr info,
            IntPtr self,
            int paramLen,
        ...
        )
        {
            try
            {
                ...
                argobj0 =
                    argobj0 != null
                        ? argobj0
                        : StaticTranslate<UnityEngine.Collider>.Get(
                            (int)data,
                            isolate,
                            NativeValueApi.GetValueFromArgument,
                            v8Value0,
                ...
                UnityEngine.Collider arg0 = (UnityEngine.Collider)argobj0;
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        internal static void G_ScoredTrigger(
            IntPtr isolate,
            IntPtr info,
            IntPtr self,
            int paramLen,
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        internal static void S_ScoredTrigger(
            IntPtr isolate,
            IntPtr info,
            IntPtr self,
            int paramLen,
