...
#pragma warning disable 0219
            ...
            try
            {

                {

                    {
                        ...
                        return Puerts.Utils.GetObjectPtr((int)data, typeof(ScriptBehaviourManager), result);
                    }
                }
    ...
    // ==================== methods start ====================
        ...
        internal static void F_AddUpdate(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        internal static void F_InvokeUpdate(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        internal static void F_InvokeStarter(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
