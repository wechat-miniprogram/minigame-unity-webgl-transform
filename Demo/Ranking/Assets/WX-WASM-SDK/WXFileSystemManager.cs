...
namespace WeChatWASM
{
    public class WXFileSystemManager
    {
        ...
        public string WriteFileSync(string filePath, string data, string encoding)
        {
        ...
        /// <param name="encoding">指定写入文件的字符编码</param>
        /// <returns>错误信息，如果成功的话返回ok</returns>
        public string WriteFileSync(string filePath, byte[] data, string encoding = "") {
            return WXWriteBinFileSync(filePath, data, data.Length, encoding);
        }


        /// <summary>
        /// 写文件, 详见 https://developers.weixin.qq.com/minigame/dev/api/file/FileSystemManager.writeFile.html
        /// </summary>
        ...
        /// <returns></returns>
        public string ReadFileSync(string filePath,string encodeing = "utf8")
        {
