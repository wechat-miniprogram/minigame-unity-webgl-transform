...
public class LaunchOpera : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        SyncDemo.onClick.AddListener(() =>
        {
            ...
            {
                content = "Successfully set, restart the game and when a new user starts playing the LaunchOpera, otherwise it will not be played.",
                showCancel = false,
            });
        });
        ...
        AsyncDemo.onClick.AddListener(() =>
        {
            ...
            WX.ShowModal(new ShowModalOption()
            {
                content = "Successfully set, restart the game and New users play the complete LaunchOpera, while old users only play the logo video.",
                showCancel = false,
            });
        });
