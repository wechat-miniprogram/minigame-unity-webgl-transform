...
public class Screen : Details
{
    ...
    private void Start()
    {
        ...
        GameManager.Instance.detailsController.BindExtraButtonAction(3, onScreenRecordingStateChanged);
   ...
   public void setVisualEffectOnCapture() {
    ...
    public void onUserCaptureScreen() {
        ...
        GameManager.Instance.detailsController.ChangeExtraButtonText(2, _isListening ? "取消监听截屏" : "开始监听截屏");
    }
    ...
    public void onScreenRecordingStateChanged() {
        ...
        GameManager.Instance.detailsController.ChangeExtraButtonText(3, _isListening1 ? "取消监听录屏" : "开始监听录屏");
    }
