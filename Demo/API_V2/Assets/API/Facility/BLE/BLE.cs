...
public class BLE : Details
{
    ...
    private readonly Action<OnBLEConnectionStateChangeListenerResult> _onBLEConnectionStateChange =
        (res) =>
        {
    ...
    private readonly Action<OnBLECharacteristicValueChangeListenerResult> _onBLECharacteristicValueChange =
        (res) =>
        {
    ...
    public void writeBLECharacteristicValue()
    {
        WX.WriteBLECharacteristicValue(
            new WriteBLECharacteristicValueOption
            {
                deviceId = "xxx",
                serviceId = "xxx",
    ...
    public void readBLECharacteristicValue()
    {
        WX.ReadBLECharacteristicValue(
            new ReadBLECharacteristicValueOption
            {
                deviceId = "xx",
                serviceId = "xx",
                characteristicId = "xx",
    ...
    public void notifyBLECharacteristicValueChange()
    {
        WX.NotifyBLECharacteristicValueChange(
            new NotifyBLECharacteristicValueChangeOption
            {
                deviceId = "xx",
                serviceId = "xx",
                characteristicId = "xx",
    ...
    public void getBLEDeviceServices()
    {
        WX.GetBLEDeviceServices(
            new GetBLEDeviceServicesOption
            {
                deviceId = "xx",
                success = (res) =>
                {
    ...
    public void getBLEDeviceCharacteristics()
    {
        WX.GetBLEDeviceCharacteristics(
            new GetBLEDeviceCharacteristicsOption
            {
                deviceId = "xx",
                serviceId = "xx",
                success = (res) =>
